...
def NormalText(cp):
    ...
    if _t1(1000):
        ...
        # (Line 12) s.print("\x13\x1BRusaruka Schwagerin\n\x13\x04[ \x06너무 얕보면... 먹어버릴거야? \x04]");
    ...
    if _t2(1100):
        ...
        _ARRW(v.Sound_Text1, cp) << (0)
        # (Line 17) s.print("\x13\x1BRusaruka Schwagerin\n\x13\x04[ \x06좋아, 내가 시험해줄게. 술래잡기를 계속하도록 할까? \x04]");
        s.print("\x13\x1BRusaruka Schwagerin\n\x13\x04[ \x06좋아, 내가 시험해줄게. 술래잡기를 계속하도록 할까? \x04]")
        # (Line 18) break;
        EUDBreak()
        # (Line 19) case 1200:
    ...
    if _t4(1500):
        ...
        _ARRW(v.Sound_Text1, cp) << (0)
        # (Line 27) s.print("\x13\x1BRusaruka Schwagerin\r\n\x13\x04[ 당신 여기서 \x06살해\x04당하고 싶어...? \x04]");
        s.print("\x13\x1BRusaruka Schwagerin\r\n\x13\x04[ 당신 여기서 \x06살해\x04당하고 싶어...? \x04]")
        # (Line 28) break;
        EUDBreak()
        # (Line 29) }
...
def UiltimateText(cp):
    ...
    if _t2(1400):
        _ARRW(v.Sound_Text_Uilti, cp) << (0)
        # (Line 43) s.printAt(3,"\x13\x1BRusaruka Schwagerin\n\n\x13\x06따라 잡을 수 없다면,\n\x13\x06아예 멈춰 세우겠다고!\n\x13\x06그렇게 생각했어! 불만있어!?");
        s.printAt(3, "\x13\x1BRusaruka Schwagerin\n\n\x13\x06따라 잡을 수 없다면,\n\x13\x06아예 멈춰 세우겠다고!\n\x13\x06그렇게 생각했어! 불만있어!?")
        # (Line 44) break;
        EUDBreak()
        # (Line 45) }
...
def UniqueText(cp):
    ...
    if _t5(1404):
        _ARRW(v.Sound_Text_Uniq, cp) << (0)
        # (Line 71) s.printAt(3,"\x13\x1BRusaruka Schwagerin\r\n\n\x13\x05Briah――\n\x13\x04창조\n\n\x13\x05Csejte Ungarn Nachtzehrer\n\x13\x04체터성의 식인그림자\n\n");
        s.printAt(3, "\x13\x1BRusaruka Schwagerin\r\n\n\x13\x05Briah――\n\x13\x04창조\n\n\x13\x05Csejte Ungarn Nachtzehrer\n\x13\x04체터성의 식인그림자\n\n")
        # (Line 72) break;
        EUDBreak()
        # (Line 73) }
