...
Trigger { -- Skill : Combo
	...
	conditions = {
		...
		Deaths(CurrentPlayer, AtMost, 4, " `SkillLoop2");
		Deaths(CurrentPlayer, Exactly, 0, " `SkillWait");
	},
	actions = {
		Comment("Skill : Combo");
...
Trigger { -- Skill : Combo
	...
	conditions = {
		...
		Deaths(CurrentPlayer, Exactly, 0, " `SkillCount");
		Deaths(CurrentPlayer, Exactly, 1, " `SkillLoop");
		Deaths(CurrentPlayer, AtLeast, 5, " `SkillLoop2");
		Deaths(CurrentPlayer, Exactly, 0, " `SkillWait");
	},
	actions = {
		Comment("Skill : Combo");
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		MoveUnit(1, "40 + 1n Wraith", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		...
		MoveUnit(1, "40 + 1n Wraith", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		Order("40 + 1n Wraith", CurrentPlayer, "Anywhere", Attack, "12.Ryuzu");
		Wait(0);
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		RemoveUnitAt(All, "40 + 1n Wraith", "Anywhere", CurrentPlayer);
		Wait(0);
		SetDeaths(AllPlayers, SetTo, 6003, " `SkillText2");
		SetDeaths(CurrentPlayer, Add, 1, " `SkillCount");
		SetDeaths(CurrentPlayer, SetTo, 0, " `SkillLoop");
		SetDeaths(CurrentPlayer, SetTo, 0, " `SkillLoop2");
	},
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Add, 0x000000E0);
		SetMemory(0x58E898, Add, 0x000000E0);
		SetMemory(0x58E894, Subtract, 0x00000020);
		SetMemory(0x58E89C, Subtract, 0x00000020);
		MoveUnit(1, "100 + 1n Hyperion", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Subtract, 0x00000020);
		SetMemory(0x58E898, Subtract, 0x00000020);
		SetMemory(0x58E894, Subtract, 0x000000E0);
		SetMemory(0x58E89C, Subtract, 0x000000E0);
		MoveUnit(1, "100 + 1n Hyperion", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Subtract, 0x000000E0);
		SetMemory(0x58E898, Subtract, 0x000000E0);
		SetMemory(0x58E894, Add, 0x00000020);
		SetMemory(0x58E89C, Add, 0x00000020);
		MoveUnit(1, "100 + 1n Hyperion", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Add, 0x00000020);
		SetMemory(0x58E898, Add, 0x00000020);
		SetMemory(0x58E894, Add, 0x000000E0);
		SetMemory(0x58E89C, Add, 0x000000E0);
		MoveUnit(1, "100 + 1n Hyperion", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		KillUnitAt(All, "100 + 1n Hyperion", "Anywhere", CurrentPlayer);
		Wait(0);
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		MoveUnit(8, "60 + 1n Archon", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Subtract, 0x00000040);
		SetMemory(0x58E898, Subtract, 0x00000040);
		SetMemory(0x58E894, Subtract, 0x00000040);
