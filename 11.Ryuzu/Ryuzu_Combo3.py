...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		CreateUnit(4, "Stasis Field", "[Skill]Unit_Wait_1", CurrentPlayer);
		...
		MoveUnit(1, "Stasis Field", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		CreateUnit(2, "Stasis Field", "[Skill]Unit_Wait_1", CurrentPlayer);
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Add, 0x00000040);
		SetMemory(0x58E898, Add, 0x00000040);
		SetMemory(0x58E894, Subtract, 0x00000100);
		SetMemory(0x58E89C, Subtract, 0x00000100);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "Stasis Field", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		SetMemory(0x58E890, Add, 0x00000040);
		SetMemory(0x58E898, Add, 0x00000040);
		SetMemory(0x58E894, Add, 0x00000100);
		SetMemory(0x58E89C, Add, 0x00000100);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "Stasis Field", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Add, 0x00000100);
		SetMemory(0x58E898, Add, 0x00000100);
		SetMemory(0x58E894, Subtract, 0x00000040);
		SetMemory(0x58E89C, Subtract, 0x00000040);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		...
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		KillUnitAt(All, "40 + 1n Gantrithor", "Anywhere", CurrentPlayer);
		GiveUnits(All, "60 + 1n Siege", CurrentPlayer, "Anywhere", P10);
		SetDeaths(CurrentPlayer, Add, 1, " `SkillCount");
		SetDeaths(CurrentPlayer, SetTo, 0, " `SkillLoop");
	},
}
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Subtract, 0x00000100);
		SetMemory(0x58E898, Subtract, 0x00000100);
		SetMemory(0x58E894, Subtract, 0x00000040);
		SetMemory(0x58E89C, Subtract, 0x00000040);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		SetMemory(0x58E89C, Subtract, 0x00000080);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 3n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "Stasis Field", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Add, 0x00000080);
		SetMemory(0x58E898, Add, 0x00000080);
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		KillUnitAt(All, "40 + 1n Gantrithor", "Anywhere", CurrentPlayer);
		GiveUnits(All, "60 + 3n Siege", CurrentPlayer, "Anywhere", P10);
		SetDeaths(CurrentPlayer, Add, 1, " `SkillLoop");
	},
}
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Add, 0x000000F0);
		SetMemory(0x58E898, Add, 0x000000F0);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Archon", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E894, Subtract, 0x000000F0);
		SetMemory(0x58E89C, Subtract, 0x000000F0);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Archon", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E890, Subtract, 0x000000F0);
		SetMemory(0x58E898, Subtract, 0x000000F0);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Archon", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E894, Add, 0x000000F0);
		SetMemory(0x58E89C, Add, 0x000000F0);
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "60 + 1n Archon", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		KillUnitAt(All, "40 + 1n Gantrithor", "Anywhere", CurrentPlayer);
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		Wait(1900);
		SetDeaths(AllPlayers, SetTo, 6011, " `SkillText2");
		SetDeaths(CurrentPlayer, Add, 1, " `SkillCount");
		SetDeaths(CurrentPlayer, SetTo, 0, " `SkillLoop");
	},
}
...
Trigger { -- Skill : Combo
	...
	actions = {
		Comment("Skill : Combo");
		PreserveTrigger();
		CreateUnit(5, "100 + 1n Hyperion", "[Skill]Unit_Wait_1", CurrentPlayer);
		...
		MoveUnit(1, " Creep. Dunkelheit", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		SetMemory(0x58E894, Subtract, 0x00000090);
		SetMemory(0x58E89C, Subtract, 0x00000090);
		MoveUnit(1, "100 + 1n Hyperion", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		MoveUnit(1, " Creep. Dunkelheit", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		MoveUnit(All, " Creep. Dunkelheit", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		KillUnitAt(All, "100 + 1n Hyperion", "Anywhere", CurrentPlayer);
		Order(" Creep. Dunkelheit", CurrentPlayer, "Anywhere", Attack, "12.Ryuzu");
		Wait(0);
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		CreateUnit(4, "40 + 1n Ghost", "[Skill]Unit_Wait_2", CurrentPlayer);
		CreateUnit(4, "40 + 1n Gantrithor", "[Skill]Unit_Wait_3", CurrentPlayer);
		CreateUnit(4, "40 + 1n Gantrithor", "[Skill]Unit_Wait_4", CurrentPlayer);
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", "60 + 3n Siege", P9, "Anywhere");
		RemoveUnitAt(1, "60 + 3n Siege", "Anywhere", P9);
		MoveUnit(1, "40 + 1n Ghost", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", "60 + 3n Siege", P9, "Anywhere");
		RemoveUnitAt(1, "60 + 3n Siege", "Anywhere", P9);
		MoveUnit(1, "40 + 1n Ghost", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		...
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", " * Devouring One", CurrentPlayer, "Anywhere");
		Order("40 + 1n Ghost", CurrentPlayer, "Anywhere", Attack, "12.Ryuzu");
		KillUnitAt(All, "40 + 1n Gantrithor", "Anywhere", CurrentPlayer);
		Wait(140);
		KillUnitAt(All, "40 + 1n Ghost", "Anywhere", CurrentPlayer);
		KillUnitAt(All, "Stasis Field", "Anywhere", CurrentPlayer);
		SetDeaths(CurrentPlayer, Add, 1, " `SkillLoop");
	},
}
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		CreateUnit(4, "40 + 1n Gantrithor", "[Skill]Unit_Wait_4", CurrentPlayer);
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", "60 + 3n Siege", P10, "Anywhere");
		RemoveUnitAt(1, "60 + 3n Siege", "Anywhere", P10);
		MoveUnit(1, "40 + 1n Ghost", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", "60 + 3n Siege", P10, "Anywhere");
		RemoveUnitAt(1, "60 + 3n Siege", "Anywhere", P10);
...
Trigger { -- Skill : Combo
	...
	actions = {
		Comment("Skill : Combo");
		PreserveTrigger();
		CreateUnit(3, "40 + 1n Ghost", "[Skill]Unit_Wait_1", CurrentPlayer);
		CreateUnit(3, "40 + 1n Ghost", "[Skill]Unit_Wait_2", CurrentPlayer);
		CreateUnit(3, "40 + 1n Gantrithor", "[Skill]Unit_Wait_3", CurrentPlayer);
		CreateUnit(3, "40 + 1n Gantrithor", "[Skill]Unit_Wait_4", CurrentPlayer);
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", "60 + 1n Siege", P10, "Anywhere");
		RemoveUnitAt(1, "60 + 1n Siege", "Anywhere", P10);
		MoveUnit(1, "40 + 1n Ghost", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", "60 + 1n Siege", P10, "Anywhere");
		RemoveUnitAt(1, "60 + 1n Siege", "Anywhere", P10);
...
Trigger { -- Skill : Combo
	...
	actions = {
		...
		CreateUnit(3, "40 + 1n Gantrithor", "[Skill]Unit_Wait_4", CurrentPlayer);
		SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
		MoveLocation("12.Ryuzu", "60 + 1n Siege", P9, "Anywhere");
		RemoveUnitAt(1, "60 + 1n Siege", "Anywhere", P9);
		MoveUnit(1, "40 + 1n Ghost", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveUnit(1, "40 + 1n Gantrithor", CurrentPlayer, "[Skill]Unit_Wait_ALL", "12.Ryuzu");
		MoveLocation("12.Ryuzu", "60 + 1n Siege", P9, "Anywhere");
		RemoveUnitAt(1, "60 + 1n Siege", "Anywhere", P9);
