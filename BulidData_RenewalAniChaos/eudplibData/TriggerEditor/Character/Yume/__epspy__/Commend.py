...
def f_main(cp):
    ...
    if EUDIf()(EUDSCAnd()(f.wait[cp] == 0)(f.step[cp] == 0)()):
        ...
        if EUDElseIf()(Bring(cp, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill")):
            # (Line 27) {
            # (Line 28) RemoveUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", cp);
    ...
    if EUDIf()(EUDSCAnd()(f.wait[cp] >= 2)(f.count[cp] == 0)()):
        ...
        if EUDElseIf()(EUDSCAnd()(Bring(cp, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(f.step[cp] == 200)()):
            ...
            # (Line 57) f.loop[cp] = 0;
            _ARRW(f.loop, cp) << (0)
            # (Line 58) f.step[cp] = 230;
            _ARRW(f.step, cp) << (230)
            # (Line 59) KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", cp);
            # (Line 60) }
            DoActions(KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", cp))
            # (Line 61) else if (Bring(cp, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill")
        _t10 = EUDElseIf()
        ...
        if _t10(EUDSCAnd()(Bring(cp, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(f.step[cp] == 230)()):
            ...
            # (Line 71) else if (Bring(cp, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill")
        _t11 = EUDElseIf()
        # (Line 72) && Bring(cp, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill")
        ...
        if _t11(EUDSCAnd()(Bring(cp, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(cp, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill"))(f.step[cp] == 200)()):
            ...
            _ARRW(f.step, cp) << (210)
            # (Line 80) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", cp);
            # (Line 81) KillUnitAt(1, "Protoss Scout", "[Skill]UseSkill", cp);
