...
def UiltimateText(cp):
    ...
    if _t1(15000):
        ...
        # (Line 50) case 15001:
    _t2 = EUDSwitchCase()
    # (Line 51) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04추억이, 슬픈 것이었다고 해도");
    if _t2(15001):
        ...
        # (Line 54) case 15002:
    _t3 = EUDSwitchCase()
    # (Line 55) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04미래를 믿으며 나아가는 거야");
    if _t3(15002):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04미래를 믿으며 나아가는 거야")
        ...
        # (Line 58) case 15003:
    _t4 = EUDSwitchCase()
    # (Line 59) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04외로움을 깨달아서");
    if _t4(15003):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04외로움을 깨달아서")
        ...
        # (Line 62) case 15004:
    _t5 = EUDSwitchCase()
    # (Line 63) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04좌절하고 싶어져도");
    if _t5(15004):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04좌절하고 싶어져도")
        ...
        # (Line 66) case 15005:
    _t6 = EUDSwitchCase()
    # (Line 67) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04당신 덕분에");
    if _t6(15005):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04당신 덕분에")
        ...
        # (Line 70) case 15006:
    _t7 = EUDSwitchCase()
    # (Line 71) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04기억해내서");
    if _t7(15006):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04기억해내서")
        ...
        # (Line 74) case 15007:
    _t8 = EUDSwitchCase()
    # (Line 75) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04강해질 수 있는 거야");
    if _t8(15007):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04강해질 수 있는 거야")
        ...
        # (Line 78) case 15008:
    _t9 = EUDSwitchCase()
    # (Line 79) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04혼자가 아니라고...");
    if _t9(15008):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04혼자가 아니라고...")
        ...
        # (Line 82) case 15009:
    _t10 = EUDSwitchCase()
    # (Line 83) f.stb.printAt(3,"\x13\x1BRin\n\x13\x04당신 덕분에...");
    if _t10(15009):
        f.stb.printAt(3, "\x13\x1BRin\n\x13\x04당신 덕분에...")
