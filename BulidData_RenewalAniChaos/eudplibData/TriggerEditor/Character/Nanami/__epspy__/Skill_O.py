    ...
    if EUDIf()(f.delay[cp] == 0):
        ...
        if EUDIf()(f.count[cp] == 0):
            ...
            if EUDIf()(f.loop[cp] == 0):
                # (Line 13) {
                # (Line 14) if (cp < 3) SetSwitch("Unique - Nanami1", Set);
                if EUDIf()(cp >= 3, neg=True):
                    # (Line 15) else SetSwitch("Unique - Nanami2", Set);
                ...
                # (Line 18) KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", cp);
                # (Line 20) SetDeaths(cp, SetTo, 2160, " `UniqueCoolTime");
                DoActions(KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", cp))
                # (Line 21) SetDeaths(cp, SetTo, 720, " `UniqueSkill");
