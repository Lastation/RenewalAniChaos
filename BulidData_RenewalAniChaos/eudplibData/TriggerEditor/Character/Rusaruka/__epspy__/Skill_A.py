...
def f_main(cp):
    ...
    if EUDIf()(f.delay[cp] == 0):
        # (Line 7) {
        # (Line 8) if(f.count[cp] == 0 || f.count[cp] == 5 || f.count[cp] == 10)
        if EUDIf()(EUDSCOr()(f.count[cp] == 0)(f.count[cp] == 5)(f.count[cp] == 10)()):
            # (Line 9) {
            # (Line 10) f.SquareShape(cp, 1, "60 + 1n Danimoth", 128, 128);
            f.SquareShape(cp, 1, "60 + 1n Danimoth", 128, 128)
            # (Line 11) f.SquareShape(cp, 1, "40 + 1n Zergling", 64, 64);
            f.SquareShape(cp, 1, "40 + 1n Zergling", 64, 64)
            # (Line 12) KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", cp);
            # (Line 13) KillUnitAt(All, "40 + 1n Zergling", "Anywhere", cp);
            ...
            # (Line 16) }
            # (Line 17) else if(f.count[cp] == 1 || f.count[cp] == 6 || f.count[cp] == 11)
        if EUDElseIf()(EUDSCOr()(f.count[cp] == 1)(f.count[cp] == 6)(f.count[cp] == 11)()):
            # (Line 18) {
            # (Line 19) f.SquareShape(cp, 1, "Kakaru", 64, 0);
            f.SquareShape(cp, 1, "Kakaru", 64, 0)
            # (Line 20) f.SquareShape(cp, 1, "40 + 1n Zealot", 128, 0);
            f.SquareShape(cp, 1, "40 + 1n Zealot", 128, 0)
            # (Line 21) KillUnitAt(All, "Kakaru", "Anywhere", cp);
