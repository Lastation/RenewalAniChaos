...
def f_main(cp):
    ...
    if EUDIf()(EUDSCAnd()(f.wait[cp] >= 2)(f.count[cp] == 0)()):
        ...
        _t9 = EUDElseIf()
        # (Line 53) && Bring(cp, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill") && f.step[cp] == 200)
        if _t9(EUDSCAnd()(Bring(cp, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(Bring(cp, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(f.step[cp] == 200)()):
            ...
            # (Line 63) else if (Bring(cp, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill") && f.step[cp] == 200)
        ...
        if _t11(EUDSCAnd()(Bring(cp, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill"))(f.step[cp] == 300)(Deaths(cp, AtLeast, f.UltimateA[cp], " `UltimateCoolTime"))()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                _ARRW(f.wait, cp) << (0)
                # (Line 83) f.count[cp] = 0;
                _ARRW(f.count, cp) << (0)
                # (Line 84) f.loop[cp] = 0;
                _ARRW(f.loop, cp) << (0)
                # (Line 85) f.step[cp] = 310;
                _ARRW(f.step, cp) << (310)
                # (Line 86) SetDeaths(cp, Subtract, f.UltimateA[cp], " `UltimateCoolTime");
                # (Line 87) KillUnitAt(3, "Protoss Arbiter", "[Skill]UseSkill", cp);
            ...
            if EUDElse()():
                ...
                # (Line 92) KillUnitAt(3, "Protoss Arbiter", "[Skill]UseSkill", cp);
