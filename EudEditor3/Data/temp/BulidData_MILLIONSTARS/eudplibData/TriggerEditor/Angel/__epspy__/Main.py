...
def Init_Weapon():
    ...
    if EUDWhile()(i >= 13, neg=True):
        ...
        # (Line 56) w.Set_Label(v.Unit_AtkID[i], 229 + i);
...
def Set_AtkPercent(type, value):
    ...
    # (Line 215) case 0:
    _t1 = EUDSwitchCase()
    # (Line 216) SetMemory(0x515BA0, SetTo, value);	// 소형 - 프린세스 	75%
    if _t1(0):
        ...
        # (Line 219) case 1:
    _t2 = EUDSwitchCase()
    # (Line 220) SetMemory(0x515BA4, SetTo, value);	// 중형 - 페어리 		100%
    if _t2(1):
        ...
        # (Line 223) case 2:
    _t3 = EUDSwitchCase()
    # (Line 224) SetMemory(0x515BA8, SetTo, value);	// 대형 - 엔젤 		50%
    if _t3(2):
