...
def Init_Weapon():
    ...
    if EUDWhile()(i >= 13, neg=True):
        def _t2():
            i.__iadd__(1)
        # (Line 51) {
        # (Line 52) w.Set_Label(v.Unit_AtkID[i], 255 + i);
...
def Set_AtkPercent(type, value):
    ...
    # (Line 210) case 0:
    _t1 = EUDSwitchCase()
    # (Line 211) SetMemory(0x515BC8, SetTo, value);	// 소형 - 프린세스 	75%
    if _t1(0):
        ...
        # (Line 214) case 1:
    _t2 = EUDSwitchCase()
    # (Line 215) SetMemory(0x515BCC, SetTo, value);	// 중형 - 페어리 		100%
    if _t2(1):
        ...
        # (Line 218) case 2:
    _t3 = EUDSwitchCase()
    # (Line 219) SetMemory(0x515BD0, SetTo, value);	// 대형 - 엔젤 		50%
    if _t3(2):
