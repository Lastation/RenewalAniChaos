...
def Set_Dear_ButtonText(id):
    ...
    if EUDIf()(v.Dear_Level[id] >= 10, neg=True):
        # (Line 38) {
        # (Line 39) settbl(1100 + id * 2, 10, v.Dear_Now[id], "/", v.Dear_Need[v.Dear_Level[id]],
        ...
        # (Line 44) {
    if EUDElse()():
        # (Line 45) settbl(1100 + id * 2, 10, v.Dear_Now[id],
...
def Set_Album_ButtonText(id):
    ...
    if EUDIf()(v.Album_Level[id] >= 10, neg=True):
        ...
        if EUDIf()(id == 6, neg=True):
            # (Line 56) {
            # (Line 57) settbl(1101 + id * 2, 8, v.Album_Now[id], "/", v.Album_Need[v.Album_Level[id]],
            ...
            f_settbl(1101 + id * 2, 8, v.Album_Now[id], "/", v.Album_Need[v.Album_Level[id]], "\n\x1B", ptr2s(v.Album_Text[id]), " Lv.", v.Album_Level[id], "\n\x04", ptr2s(v.Album_SubText[id]), " \x08", v.Album_Level[id] * v.Album_Multiply[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]))
            # (Line 60) }
            # (Line 61) else
            # (Line 62) {
        if EUDElse()():
            # (Line 63) settbl(1101 + id * 2, 8, v.Album_Now[id], "/", v.Album_Need[v.Album_Level[id]],
            # (Line 64) "\n\x1B", ptr2s(v.Album_Text[id])," Lv.", v.Album_Level[id],
    ...
    if EUDElse()():
        ...
        if EUDIf()(id == 6, neg=True):
            # (Line 71) {
            # (Line 72) settbl(1101 + id * 2, 8, v.Album_Now[id],
            # (Line 73) "\n\x1B", ptr2s(v.Album_Text[id])," Lv. Max",
            # (Line 74) "\n\x04", ptr2s(v.Album_SubText[id]), " \x08", v.Album_Level[id] * v.Album_Multiply[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]));
            f_settbl(1101 + id * 2, 8, v.Album_Now[id], "\n\x1B", ptr2s(v.Album_Text[id]), " Lv. Max", "\n\x04", ptr2s(v.Album_SubText[id]), " \x08", v.Album_Level[id] * v.Album_Multiply[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]))
            # (Line 75) }
            # (Line 76) else
            # (Line 77) {
        if EUDElse()():
            # (Line 78) settbl(1101 + id * 2, 8, v.Album_Now[id],
            # (Line 79) "\n\x1B", ptr2s(v.Album_Text[id])," Lv. Max",
            # (Line 80) "\n\x08", v.Album_Multiply[id] -  v.Album_Level[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]));
            f_settbl(1101 + id * 2, 8, v.Album_Now[id], "\n\x1B", ptr2s(v.Album_Text[id]), " Lv. Max", "\n\x08", v.Album_Multiply[id] - v.Album_Level[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]))
            # (Line 81) }
...
def Set_AlbumLevel(id):
    ...
    if EUDIf()(EUDSCAnd()(v.Album_Now[id] >= v.Album_Need[v.Album_Level[id]])(v.Album_Level[id] >= 10, neg=True)()):
        ...
        # (Line 119) case 1:
        _t2 = EUDSwitchCase()
        # (Line 120) value = ((v.Album_Multiply[1] * v.Album_Level[1] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) / 100 + v.Base_AtkPercent[0];
        if _t2(1):
            ...
            # (Line 124) case 5:
        _t3 = EUDSwitchCase()
        # (Line 125) value = ((v.Album_Multiply[5] * v.Album_Level[5] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) / 100 + v.Base_AtkPercent[1];
        if _t3(5):
        ...
        if _t4(9):
            ...
            # (Line 134) case 4:
        _t5 = EUDSwitchCase()
        # (Line 135) value = ((v.Album_Multiply[1] * v.Album_Level[1] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) / 100 + v.Base_AtkPercent[0];
        if _t5(4):
            value << (((v.Album_Multiply[1] * v.Album_Level[1] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) // 100 + v.Base_AtkPercent[0])
            # (Line 136) m.Set_AtkPercent(0, value);
            m.Set_AtkPercent(0, value)
            # (Line 137) value = ((v.Album_Multiply[5] * v.Album_Level[5] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) / 100 + v.Base_AtkPercent[1];
            value << (((v.Album_Multiply[5] * v.Album_Level[5] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) // 100 + v.Base_AtkPercent[1])
            # (Line 138) m.Set_AtkPercent(1, value);
            m.Set_AtkPercent(1, value)
            # (Line 139) value = ((v.Album_Multiply[9] * v.Album_Level[9] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) / 100 + v.Base_AtkPercent[2];
            value << (((v.Album_Multiply[9] * v.Album_Level[9] + v.Album_Multiply[4] * v.Album_Level[4]) * 256 + 256) // 100 + v.Base_AtkPercent[2])
