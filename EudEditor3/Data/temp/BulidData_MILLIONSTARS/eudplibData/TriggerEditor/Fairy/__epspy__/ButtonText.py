...
def Set_Dear_ButtonText(id):
    ...
    if EUDIf()(v.Dear_Level[id] >= 10, neg=True):
        # (Line 29) {
        # (Line 30) settbl(1074 + id * 2, 10, v.Dear_Now[id], "/", v.Dear_Need[v.Dear_Level[id]],
        ...
        # (Line 35) {
    if EUDElse()():
        # (Line 36) settbl(1074 + id * 2, 10, v.Dear_Now[id],
...
def Set_Album_ButtonText(id):
    ...
    if EUDIf()(v.Album_Level[id] >= 10, neg=True):
        ...
        if EUDIf()(id == 7, neg=True):
            # (Line 47) {
            # (Line 48) settbl(1075 + id * 2, 15, v.Album_Now[id], ptr2s(v.Album_Text[13]),
            ...
            f_settbl(1075 + id * 2, 15, v.Album_Now[id], ptr2s(v.Album_Text[13]), "\n\x1C", ptr2s(v.Album_Text[id]), " Lv.", v.Album_Level[id], "\n\x04", ptr2s(v.Album_SubText[id]), " \x08", v.Album_Level[id] * v.Album_Multiply[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]))
            # (Line 51) }
            # (Line 52) else
            # (Line 53) {
        if EUDElse()():
            # (Line 54) settbl(1075 + id * 2, 15, v.Album_Now[id], ptr2s(v.Album_Text[13]),
            # (Line 55) "\n\x1C", ptr2s(v.Album_Text[id])," Lv.", v.Album_Level[id],
    ...
    if EUDElse()():
        ...
        if EUDIf()(id == 7, neg=True):
            # (Line 62) {
            # (Line 63) settbl(1075 + id * 2, 15, v.Album_Now[id], ptr2s(v.Album_Text[13]),
            ...
            # (Line 68) {
        if EUDElse()():
            # (Line 69) settbl(1075 + id * 2, 15, v.Album_Now[id], ptr2s(v.Album_Text[13]),
            # (Line 70) "\n\x1C", ptr2s(v.Album_Text[id])," Lv. Max",
            # (Line 71) "\n\x08", v.Album_Multiply[id] -  v.Album_Level[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]));
            f_settbl(1075 + id * 2, 15, v.Album_Now[id], ptr2s(v.Album_Text[13]), "\n\x1C", ptr2s(v.Album_Text[id]), " Lv. Max", "\n\x08", v.Album_Multiply[id] - v.Album_Level[id], ptr2s(v.Album_EndText[v.Album_Ablity[id]]))
            # (Line 72) }
...
def Set_AlbumLevel(id):
    ...
    if EUDIf()(EUDSCAnd()(v.Album_Now[id] >= v.Album_Need[v.Album_Level[id]])(v.Album_Level[id] >= 10, neg=True)()):
        ...
        # (Line 110) case 12:
        _t2 = EUDSwitchCase()
        # (Line 111) value = ((v.Album_Multiply[12] * v.Album_Level[12] + v.Album_Multiply[5] * v.Album_Level[5]) * 256 + 256) / 100 + v.Base_AtkPercent[0];
        if _t2(12):
            ...
            # (Line 115) case 0:
        _t3 = EUDSwitchCase()
        # (Line 116) value = ((v.Album_Multiply[0] * v.Album_Level[0] + v.Album_Multiply[5] * v.Album_Level[5]) * 256 + 256) / 100 + v.Base_AtkPercent[1];
        if _t3(0):
            ...
            # (Line 120) case 4:
        _t4 = EUDSwitchCase()
        # (Line 121) value = ((v.Album_Multiply[4] * v.Album_Level[4] + v.Album_Multiply[5] * v.Album_Level[5]) * 256 + 256) / 100 + v.Base_AtkPercent[2];
        if _t4(4):
            ...
            # (Line 125) case 5:
        _t5 = EUDSwitchCase()
        # (Line 126) value = ((v.Album_Multiply[12] * v.Album_Level[12] + v.Album_Multiply[5] * v.Album_Level[5]) * 256 + 256) / 100 + v.Base_AtkPercent[0];
        if _t5(5):
            value << (((v.Album_Multiply[12] * v.Album_Level[12] + v.Album_Multiply[5] * v.Album_Level[5]) * 256 + 256) // 100 + v.Base_AtkPercent[0])
            # (Line 127) m.Set_AtkPercent(0, value);
            m.Set_AtkPercent(0, value)
            # (Line 128) value = ((v.Album_Multiply[0] * v.Album_Level[0] + v.Album_Multiply[5] * v.Album_Level[5]) * 256 + 256) / 100 + v.Base_AtkPercent[1];
            value << (((v.Album_Multiply[0] * v.Album_Level[0] + v.Album_Multiply[5] * v.Album_Level[5]) * 256 + 256) // 100 + v.Base_AtkPercent[1])
