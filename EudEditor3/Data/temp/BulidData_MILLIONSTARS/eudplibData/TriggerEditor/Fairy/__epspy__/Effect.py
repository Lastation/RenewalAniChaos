...
def Update_Effect():
    ...
    Effect_Unit(3, 0)
    # (Line 26) Effect_Unit(10, 0);
    Effect_Unit(10, 0)
    # (Line 29) Effect_Unit(2, 1);
    Effect_Unit(2, 1)
    # (Line 32) Effect_Unit(1, 2);
    Effect_Unit(1, 2)
    # (Line 33) Effect_Unit(9, 2);
    Effect_Unit(9, 2)
    # (Line 36) Effect_Unit(7, 3);
    Effect_Unit(7, 3)
    # (Line 37) }
    ...
    if EUDIf()(Bring(Force1, AtLeast, 1, v.Unit_ID[id], "Anywhere")):
        ...
        if _t12(3):
            if EUDIf()(EUDSCAnd()(v.Album_Delay[id] >= v.Album_Multiply[id] - v.Album_Level[id])(v.Album_Level[id] >= 1)()):
                ...
                _ARRW(v.Album_Delay, id) << (0)
                # (Line 91) ModifyUnitHitPoints(1, 94, P7, "Player1", 1);
                # (Line 92) ModifyUnitHitPoints(1, 94, P7, "Player2", 1);
                DoActions(ModifyUnitHitPoints(1, 94, P7, "Player1", 1))
                # (Line 93) ModifyUnitHitPoints(1, 94, P7, "Player3", 1);
                DoActions(ModifyUnitHitPoints(1, 94, P7, "Player2", 1))
                # (Line 94) ModifyUnitHitPoints(1, 94, P7, "Player4", 1);
                DoActions(ModifyUnitHitPoints(1, 94, P7, "Player3", 1))
                # (Line 95) ModifyUnitHitPoints(1, 94, P7, "Player5", 1);
