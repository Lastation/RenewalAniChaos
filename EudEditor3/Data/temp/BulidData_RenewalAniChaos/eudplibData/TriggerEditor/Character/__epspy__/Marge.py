...
# (Line 24) import Character.TextD.MN 		as mn;
from Character.TextD import MN as mn
# (Line 26) function MargeSound(cp)
# (Line 27) {
@EUDFunc
def MargeSound(cp):
    # (Line 29) if (Deaths((13), (0), 1, (186)))
    if EUDIf()(Deaths((13), (0), 1, (186))):
        # (Line 30) {
        # (Line 31) v.Sound_Text1[cp] = dwread_epd(EPD(0x58A364 + 48 * 186 + 4 * cp));
        _ARRW(v.Sound_Text1, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 186 + 4 * cp)))
        # (Line 32) SetDeaths((13), (7), 0, (186));
        # (Line 34) const Condition = v.Sound_Text1[cp];
        DoActions(SetDeaths((13), (7), 0, (186)))
        Condition = v.Sound_Text1[cp]
        # (Line 35) rusaruka.NormalText(cp);
        rusaruka.NormalText(cp)
        # (Line 36) chtholly.NormalText(cp);
        chtholly.NormalText(cp)
        # (Line 37) maihime.NormalText(cp);
        maihime.NormalText(cp)
        # (Line 38) tenshi.NormalText(cp);
        tenshi.NormalText(cp)
        # (Line 39) miyuki.NormalText(cp);
        miyuki.NormalText(cp)
        # (Line 40) negev.NormalText(cp);
        negev.NormalText(cp)
        # (Line 41) }
        # (Line 44) if (Deaths((13), (0), 1, (174)))
    EUDEndIf()
    if EUDIf()(Deaths((13), (0), 1, (174))):
        # (Line 45) {
        # (Line 46) v.Sound_Text2[cp] = dwread_epd(EPD(0x58A364 + 48 * 174 + 4 * cp));
        _ARRW(v.Sound_Text2, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 174 + 4 * cp)))
        # (Line 47) SetDeaths((13), (7), 0, (174));
        # (Line 49) const Condition = v.Sound_Text2[cp];
        DoActions(SetDeaths((13), (7), 0, (174)))
        Condition = v.Sound_Text2[cp]
        # (Line 50) cecillia.NormalText(cp);
        cecillia.NormalText(cp)
        # (Line 51) anzu.NormalText(cp);
        anzu.NormalText(cp)
        # (Line 52) hotomoka.NormalText(cp);
        hotomoka.NormalText(cp)
        # (Line 53) alterego.NormalText(cp);
        alterego.NormalText(cp)
        # (Line 55) ryuzu.NormalText(cp);
        ryuzu.NormalText(cp)
        # (Line 56) }
        # (Line 59) if (Deaths((13), (0), 1, (117)))
    EUDEndIf()
    if EUDIf()(Deaths((13), (0), 1, (117))):
        # (Line 60) {
        # (Line 61) v.Sound_Text3[cp] = dwread_epd(EPD(0x58A364 + 48 * 117 + 4 * cp));
        _ARRW(v.Sound_Text3, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 117 + 4 * cp)))
        # (Line 62) SetDeaths((13), (7), 0, (117));
        # (Line 64) const Condition = v.Sound_Text3[cp];
        DoActions(SetDeaths((13), (7), 0, (117)))
        Condition = v.Sound_Text3[cp]
        # (Line 66) sakura.NormalText(cp);
        sakura.NormalText(cp)
        # (Line 67) yashiro.NormalText(cp);
        yashiro.NormalText(cp)
        # (Line 68) rin.NormalText(cp);
        rin.NormalText(cp)
        # (Line 69) seraphim.NormalText(cp);
        seraphim.NormalText(cp)
        # (Line 70) kiana.NormalText(cp);
        kiana.NormalText(cp)
        # (Line 71) tenkei.NormalText(cp);
        tenkei.NormalText(cp)
        # (Line 72) }
        # (Line 75) if (Deaths((13), (0), 1, (157)))
    EUDEndIf()
    if EUDIf()(Deaths((13), (0), 1, (157))):
        # (Line 76) {
        # (Line 77) v.Sound_Text4[cp] = dwread_epd(EPD(0x58A364 + 48 * 157 + 4 * cp));
        _ARRW(v.Sound_Text4, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 157 + 4 * cp)))
        # (Line 78) SetDeaths((13), (7), 0, (157));
        # (Line 80) const Condition = v.Sound_Text4[cp];
        DoActions(SetDeaths((13), (7), 0, (157)))
        Condition = v.Sound_Text4[cp]
        # (Line 82) mn.NormalText(cp);
        mn.NormalText(cp)
        # (Line 83) }
        # (Line 85) if (Deaths((13), (0), 1, (222)))
    EUDEndIf()
    if EUDIf()(Deaths((13), (0), 1, (222))):
        # (Line 86) {
        # (Line 87) v.Sound_Text_Uilti[cp] = dwread_epd(EPD(0x58A364 + 48 * 222 + 4 * cp));
        _ARRW(v.Sound_Text_Uilti, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 222 + 4 * cp)))
        # (Line 88) SetDeaths((13), (7), 0, (222));
        # (Line 90) const Condition = v.Sound_Text_Uilti[cp];
        DoActions(SetDeaths((13), (7), 0, (222)))
        Condition = v.Sound_Text_Uilti[cp]
        # (Line 92) rusaruka.UiltimateText(cp);
        rusaruka.UiltimateText(cp)
        # (Line 93) chtholly.UiltimateText(cp);
        chtholly.UiltimateText(cp)
        # (Line 94) maihime.UiltimateText(cp);
        maihime.UiltimateText(cp)
        # (Line 95) tenshi.UiltimateText(cp);
        tenshi.UiltimateText(cp)
        # (Line 96) miyuki.UiltimateText(cp);
        miyuki.UiltimateText(cp)
        # (Line 97) negev.UiltimateText(cp);
        negev.UiltimateText(cp)
        # (Line 100) cecillia.UiltimateText(cp);
        cecillia.UiltimateText(cp)
        # (Line 101) anzu.UiltimateText(cp);
        anzu.UiltimateText(cp)
        # (Line 102) hotomoka.UiltimateText(cp);
        hotomoka.UiltimateText(cp)
        # (Line 103) alterego.UiltimateText(cp);
        alterego.UiltimateText(cp)
        # (Line 105) ryuzu.UiltimateText(cp);
        ryuzu.UiltimateText(cp)
        # (Line 108) sakura.UiltimateText(cp);
        sakura.UiltimateText(cp)
        # (Line 109) yashiro.UiltimateText(cp);
        yashiro.UiltimateText(cp)
        # (Line 110) rin.UiltimateText(cp);
        rin.UiltimateText(cp)
        # (Line 111) seraphim.UiltimateText(cp);
        seraphim.UiltimateText(cp)
        # (Line 112) kiana.UiltimateText(cp);
        kiana.UiltimateText(cp)
        # (Line 113) tenkei.UiltimateText(cp);
        tenkei.UiltimateText(cp)
        # (Line 115) mn.UiltimateText(cp);
        mn.UiltimateText(cp)
        # (Line 116) }
        # (Line 117) if (Deaths((13), (0), 1, (188)))
    EUDEndIf()
    if EUDIf()(Deaths((13), (0), 1, (188))):
        # (Line 118) {
        # (Line 119) v.Sound_Text_Uniq[cp] = dwread_epd(EPD(0x58A364 + 48 * 188 + 4 * cp));
        _ARRW(v.Sound_Text_Uniq, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 188 + 4 * cp)))
        # (Line 120) SetDeaths((13), (7), 0, (188));
        # (Line 122) const Condition = v.Sound_Text_Uniq[cp];
        DoActions(SetDeaths((13), (7), 0, (188)))
        Condition = v.Sound_Text_Uniq[cp]
        # (Line 124) rusaruka.UniqueText(cp);
        rusaruka.UniqueText(cp)
        # (Line 125) chtholly.UniqueText(cp);
        chtholly.UniqueText(cp)
        # (Line 126) maihime.UniqueText(cp);
        maihime.UniqueText(cp)
        # (Line 127) tenshi.UniqueText(cp);
        tenshi.UniqueText(cp)
        # (Line 128) miyuki.UniqueText(cp);
        miyuki.UniqueText(cp)
        # (Line 129) negev.UniqueText(cp);
        negev.UniqueText(cp)
        # (Line 132) cecillia.UniqueText(cp);
        cecillia.UniqueText(cp)
        # (Line 133) anzu.UniqueText(cp);
        anzu.UniqueText(cp)
        # (Line 134) hotomoka.UniqueText(cp);
        hotomoka.UniqueText(cp)
        # (Line 135) alterego.UniqueText(cp);
        alterego.UniqueText(cp)
        # (Line 137) ryuzu.UniqueText(cp);
        ryuzu.UniqueText(cp)
        # (Line 140) sakura.UniqueText(cp);
        sakura.UniqueText(cp)
        # (Line 141) yashiro.UniqueText(cp);
        yashiro.UniqueText(cp)
        # (Line 142) rin.UniqueText(cp);
        rin.UniqueText(cp)
        # (Line 143) seraphim.UniqueText(cp);
        seraphim.UniqueText(cp)
        # (Line 144) kiana.UniqueText(cp);
        kiana.UniqueText(cp)
        # (Line 145) tenkei.UniqueText(cp);
        tenkei.UniqueText(cp)
        # (Line 147) mn.UniqueText(cp);
        mn.UniqueText(cp)
        # (Line 148) }
        # (Line 149) }
    EUDEndIf()
