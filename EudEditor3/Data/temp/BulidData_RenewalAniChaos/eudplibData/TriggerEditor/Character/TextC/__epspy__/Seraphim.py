...
def UniqueText(cp):
    ...
    if _t9(16017):
        ...
        # (Line 100) case 16021:
    _t10 = EUDSwitchCase()
    # (Line 101) f.stb.printAt(3,"\x13\x02\" \x02너의 \x02\"                \n\n");
    if _t10(16021):
        ...
        # (Line 104) case 16022:
    _t11 = EUDSwitchCase()
    # (Line 105) f.stb.printAt(3,"\x13\x04\" \x04너의 \x04\"                \n\n");
    if _t11(16022):
        ...
        # (Line 108) case 16023:
    _t12 = EUDSwitchCase()
    # (Line 109) f.stb.printAt(3,"\x13\x04\" \x04너의 \x04\"                \n\x13\x02          \" \x02소원 \x02\"\n");
    if _t12(16023):
        f.stb.printAt(3, "\x13\x04\" \x04너의 \x04\"                \n\x13\x02          \" \x02소원 \x02\"\n")
        ...
        # (Line 112) case 16024:
    _t13 = EUDSwitchCase()
    # (Line 113) f.stb.printAt(3,"\x13\x04\" \x04너의 \x04\"                \n\x13\x04          \" \x04소원 \x04\"\n");
    if _t13(16024):
        f.stb.printAt(3, "\x13\x04\" \x04너의 \x04\"                \n\x13\x04          \" \x04소원 \x04\"\n")
        ...
        # (Line 116) case 16031:
    _t14 = EUDSwitchCase()
    # (Line 117) f.stb.printAt(3,"\x13\x02\" \x02신의 소원을 지키기 위해           \n\n");
    if _t14(16031):
        ...
        # (Line 120) case 16032:
    _t15 = EUDSwitchCase()
    # (Line 121) f.stb.printAt(3,"\x13\x04\" 신의 소원을 지키기 위해           \n\n");
    if _t15(16032):
        ...
        # (Line 124) case 16033:
    _t16 = EUDSwitchCase()
    # (Line 125) f.stb.printAt(3,"\x13\x04\" 신의 소원을 지키기 위해           \n\x13\x1B             인간은 어리석은 맹세를 하였다 \"\n");
    if _t16(16033):
        f.stb.printAt(3, "\x13\x04\" 신의 소원을 지키기 위해           \n\x13\x1B             인간은 어리석은 맹세를 하였다 \"\n")
        ...
        # (Line 128) case 16034:
    _t17 = EUDSwitchCase()
    # (Line 129) f.stb.printAt(3,"\x13\x04\" 신의 소원을 지키기 위해           \n\x13\x08             인간은 어리석은 맹세를 하였다 \"\n");
    if _t17(16034):
        f.stb.printAt(3, "\x13\x04\" 신의 소원을 지키기 위해           \n\x13\x08             인간은 어리석은 맹세를 하였다 \"\n")
        ...
        # (Line 132) case 16041:
    _t18 = EUDSwitchCase()
    # (Line 133) f.stb.printAt(3,"\x13\x02\" 영원히 윤회에 속박되고       \n\n\n");
    if _t18(16041):
        ...
        # (Line 136) case 16042:
    _t19 = EUDSwitchCase()
    # (Line 137) f.stb.printAt(3,"\x13\x04\" 영원히 윤회에 속박되고       \n  \n\n");
    if _t19(16042):
        ...
        # (Line 140) case 16043:
    _t20 = EUDSwitchCase()
    # (Line 141) f.stb.printAt(3,"\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x02             영원히 시간 속에서 헤맨다 \"       \n\n");
    if _t20(16043):
        f.stb.printAt(3, "\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x02             영원히 시간 속에서 헤맨다 \"       \n\n")
        ...
        # (Line 144) case 16044:
    _t21 = EUDSwitchCase()
    # (Line 145) f.stb.printAt(3,"\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x04             영원히 시간 속에서 헤맨다 \"       \n\n");
    if _t21(16044):
        f.stb.printAt(3, "\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x04             영원히 시간 속에서 헤맨다 \"       \n\n")
        ...
        # (Line 148) case 16045:
    _t22 = EUDSwitchCase()
    # (Line 149) f.stb.printAt(3,"\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x04             영원히 시간 속에서 헤맨다 \"       \n\x13\x1B             \" 신이라는 존재는 그저... \"\n");
    if _t22(16045):
        f.stb.printAt(3, "\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x04             영원히 시간 속에서 헤맨다 \"       \n\x13\x1B             \" 신이라는 존재는 그저... \"\n")
        ...
        # (Line 152) case 16046:
    _t23 = EUDSwitchCase()
    # (Line 153) f.stb.printAt(3,"\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x04             영원히 시간 속에서 헤맨다 \"       \n\x13\x08             \" 신이라는 존재는 그저... \"\n");
    if _t23(16046):
        f.stb.printAt(3, "\x13\x04\" 영원히 윤회에 속박되고       \n\x13\x04             영원히 시간 속에서 헤맨다 \"       \n\x13\x08             \" 신이라는 존재는 그저... \"\n")
        ...
        # (Line 156) case 16051:
    _t24 = EUDSwitchCase()
    # (Line 157) f.stb.printAt(3,"\x13\x02\" 홀로 \"   \" 모래성을 쌓는 자일 뿐 \"\n\n");
    if _t24(16051):
        ...
        # (Line 160) case 16052:
    _t25 = EUDSwitchCase()
    # (Line 161) f.stb.printAt(3,"\x13\x04\" 홀로 \"   \" 모래성을 쌓는 자일 뿐 \"\n\n");
    if _t25(16052):
