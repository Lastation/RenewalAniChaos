...
def SetVariable(cp):
    ...
    # (Line 16) v.DeathCount[cp] = dwread_epd(EPD(0x58A364 + 48 * 210 + 4 * cp))/12;
    _ARRW(v.DeathCount, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 210 + 4 * cp)) // 12)
    # (Line 17) v.Unique_Cool[cp] = dwread_epd(EPD(0x58A364 + 48 * 203 + 4 * cp))/12;
    _ARRW(v.Unique_Cool, cp) << (f_dwread_epd(EPD(0x58A364 + 48 * 203 + 4 * cp)) // 12)
    # (Line 19) if (bread(0x58D2B0 + 0x207C * ((7) / 46) + (cp) * (46 - 31 * ((7) / 46)) + ((7) % 46)) != bread(0x58D2B0 + 35 + 46 * cp))
    if EUDIf()(f_bread(0x58D2B0 + 0x207C * ((7) // 46) + (cp) * (46 - 31 * ((7) // 46)) + ((7) % 46)) == f_bread(0x58D2B0 + 35 + 46 * cp), neg=True):
        # (Line 20) { bwrite(0x58D2B0 + 0x207C * ((35) / 46) + (cp) * (46 - 31 * ((35) / 46)) + ((35) % 46), bread(0x58D2B0 + 7 + 46 * cp)); }
        f_bwrite(0x58D2B0 + 0x207C * ((35) // 46) + (cp) * (46 - 31 * ((35) // 46)) + ((35) % 46), f_bread(0x58D2B0 + 7 + 46 * cp))
        # (Line 21) v.Dfs[cp] = bread(0x58D2B0 + 0 + 46 * cp);
    EUDEndIf()
    _ARRW(v.Dfs, cp) << (f_bread(0x58D2B0 + 0 + 46 * cp))
    # (Line 22) v.Atk[cp] = bread(0x58D2B0 + 7 + 46 * cp);
    _ARRW(v.Atk, cp) << (f_bread(0x58D2B0 + 7 + 46 * cp))
    # (Line 24) switch (v.Hero_Num[cp])	// 방어력 관련
    EUDSwitch(v.Hero_Num[cp])
    # (Line 25) {
    # (Line 26) case 10:	//얼터
    _t2 = EUDSwitchCase()
    # (Line 27) if (Deaths((13), (0), 1, (204)))
    if _t2(10):
        if EUDIf()(Deaths((13), (0), 1, (204))):
            # (Line 28) {
            # (Line 29) v.Dfs[cp] += 10;
            _ARRW(v.Dfs, cp).__iadd__(10)
            # (Line 30) SetDeaths((13), (9), 1, (204));
            # (Line 31) }
        ...
        # (Line 33) case 18:	//텐케이
    _t4 = EUDSwitchCase()
    # (Line 34) if (Deaths(CurrentPlayer, Exactly, 320, " `SkillStep")) v.Dfs[cp] = 200;
    if _t4(18):
        ...
        # (Line 36) case 22:	//유우나
    _t6 = EUDSwitchCase()
    # (Line 37) v.Dfs[cp] -= 3 * dwread_epd(204 * 12 + cp);
    if _t6(22):
        _ARRW(v.Dfs, cp).__isub__(3 * f_dwread_epd(204 * 12 + cp))
        # (Line 38) break;
        EUDBreak()
        # (Line 39) }
    # (Line 42) switch (v.Hero_Num[cp])	// 공격력 관련
    EUDEndSwitch()
    EUDSwitch(v.Hero_Num[cp])
    # (Line 43) {
    # (Line 44) case 14:
    _t7 = EUDSwitchCase()
    # (Line 45) v.Atk[cp] += 2 * dwread_epd(204 * 12 + cp);
    if _t7(14):
        ...
        # (Line 47) case 22:
    _t8 = EUDSwitchCase()
    # (Line 48) v.Atk[cp] += 3 * dwread_epd(204 * 12 + cp);
    if _t8(22):
        ...
        # (Line 50) case 30:
    _t9 = EUDSwitchCase()
    # (Line 51) if (Deaths(cp, AtLeast, 1, " `UniqueSkill"))
    if _t9(30):
        ...
        EUDBreak()
        # (Line 54) }
    # (Line 55) if (cp < 3 && Switch("Passive - Nanami1", Set) && Bring(cp, AtLeast, 1, "Any unit", "24.Nanami_Bozo")) { v.Atk[cp] += 5; v.Dfs[cp] += 5; }
    EUDEndSwitch()
    if EUDIf()(EUDSCAnd()(cp >= 3, neg=True)(Switch("Passive - Nanami1", Set))(Bring(cp, AtLeast, 1, "Any unit", "24.Nanami_Bozo"))()):
        ...
        # (Line 56) else if (cp >= 3 && Switch("Passive - Nanami2", Set) && Bring(cp, AtLeast, 1, "Any unit", "24.Nanami_Bozo")) { v.Atk[cp] += 5; v.Dfs[cp] += 5; }
    if EUDElseIf()(EUDSCAnd()(cp >= 3)(Switch("Passive - Nanami2", Set))(Bring(cp, AtLeast, 1, "Any unit", "24.Nanami_Bozo"))()):
        _ARRW(v.Atk, cp).__iadd__(5)
        _ARRW(v.Dfs, cp).__iadd__(5)
        # (Line 58) if (cp < 3 && Switch("Unique - Nanami1", Set)) { v.Atk[cp] += 5; v.Dfs[cp] += 5; }
    EUDEndIf()
    if EUDIf()(EUDSCAnd()(cp >= 3, neg=True)(Switch("Unique - Nanami1", Set))()):
        _ARRW(v.Atk, cp).__iadd__(5)
        _ARRW(v.Dfs, cp).__iadd__(5)
        # (Line 59) else if (cp >= 3 && Switch("Unique - Nanami2", Set)) { v.Atk[cp] += 5; v.Dfs[cp] += 5; }
    if EUDElseIf()(EUDSCAnd()(cp >= 3)(Switch("Unique - Nanami2", Set))()):
        _ARRW(v.Atk, cp).__iadd__(5)
        _ARRW(v.Dfs, cp).__iadd__(5)
        # (Line 61) if (s.ekidonaDebuff[cp] >= 1) v.Atk[cp] -= 5 * s.ekidonaDebuff[cp];
    EUDEndIf()
    if EUDIf()(s.ekidonaDebuff[cp] >= 1):
        _ARRW(v.Atk, cp).__isub__(5 * s.ekidonaDebuff[cp])
        # (Line 63) bwrite(0x58D2B0 + 0x207C * ((2) / 46) + (cp) * (46 - 31 * ((2) / 46)) + ((2) % 46), v.Dfs[cp]); 	//방어력 최종 적용
    EUDEndIf()
    f_bwrite(0x58D2B0 + 0x207C * ((2) // 46) + (cp) * (46 - 31 * ((2) // 46)) + ((2) % 46), v.Dfs[cp])
    # (Line 64) bwrite(0x58D2B0 + 0x207C * ((9) / 46) + (cp) * (46 - 31 * ((9) / 46)) + ((9) % 46), v.Atk[cp]);	//공격력 최종 적용
    f_bwrite(0x58D2B0 + 0x207C * ((9) // 46) + (cp) * (46 - 31 * ((9) // 46)) + ((9) % 46), v.Atk[cp])
    # (Line 66) ModifyUnitShields(All, f.heroID[cp], cp, "Anywhere", v.Shield[cp]);			//쉴드 고정
    # (Line 67) }
