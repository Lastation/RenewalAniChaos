    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 0):
                # (Line 14) {
                # (Line 15) trg.Shape_Square(playerID,1,"40 + 1n Mutalisk",48,0);
                trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 48, 0)
                # (Line 16) trg.Shape_Square(playerID,1,"40 + 1n Mutalisk",96,0);
                trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 96, 0)
                # (Line 17) trg.Shape_Square(playerID,1,"40 + 1n Mutalisk",144,0);
                ...
                # (Line 19) Order("40 + 1n Mutalisk",playerID,"Anywhere",Attack,v.P_LocationID[playerID]);
                # (Line 20) trg.Main_Wait(300);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 1):
                # (Line 23) {
                # (Line 24) trg.Shape_Square(playerID,1,"40 + 1n Guardian",48,48);
                trg.Shape_Square(playerID, 1, "40 + 1n Guardian", 48, 48)
                # (Line 25) trg.Shape_Square(playerID,1,"40 + 1n Guardian",96,96);
                trg.Shape_Square(playerID, 1, "40 + 1n Guardian", 96, 96)
                # (Line 26) trg.Shape_Square(playerID,1,"40 + 1n Guardian",144,144);
