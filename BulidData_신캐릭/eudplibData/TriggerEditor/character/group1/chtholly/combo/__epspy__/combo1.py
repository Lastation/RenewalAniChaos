    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 0):
                ...
                trg.Main_Wait(250)
                # (Line 15) }
                # (Line 16) else if (v.P_LoopMain[playerID] <= 4)
            if EUDElseIf()(v.P_LoopMain[playerID] <= 4):
                # (Line 17) {
                # (Line 18) trg.Shape_Line(playerID,1,"50 + 1n Tank",45*v.P_LoopMain[playerID],2,320,0);
                trg.Shape_Line(playerID, 1, "50 + 1n Tank", 45 * v.P_LoopMain[playerID], 2, 320, 0)
                # (Line 19) trg.Shape_Line(playerID,1,"Terran Science Vessel",45*v.P_LoopMain[playerID],2,320,0);
                trg.Shape_Line(playerID, 1, "Terran Science Vessel", 45 * v.P_LoopMain[playerID], 2, 320, 0)
                ...
                # (Line 22) Order("50 + 1n Tank", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
                # (Line 23) trg.Main_Wait(125);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 6):
                # (Line 30) {
                # (Line 31) trg.Shape_Edge(playerID,1,"50 + 1n Battlecruiser",45,3,64);
                trg.Shape_Edge(playerID, 1, "50 + 1n Battlecruiser", 45, 3, 64)
