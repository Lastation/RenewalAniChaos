    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 2):
                # (Line 22) {
                # (Line 23) trg.Shape_NxNSquare(playerID,1,"80 + 1n Tank",3,64);
                trg.Shape_NxNSquare(playerID, 1, "80 + 1n Tank", 3, 64)
                # (Line 24) trg.Shape_NxNSquare(playerID,1,"80 + 1n Artanis",3,48);
                ...
                # (Line 26) Order("80 + 1n Tank",playerID,"Anywhere",Attack,v.P_LocationID[playerID]);
                # (Line 27) Order("80 + 1n Artanis",playerID,"Anywhere",Attack,v.P_LocationID[playerID]);
