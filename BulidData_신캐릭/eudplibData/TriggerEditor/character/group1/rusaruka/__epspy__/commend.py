...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if EUDIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 100)()):
            ...
            # (Line 49) else if (Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill")
        _t9 = EUDElseIf()
        # (Line 50) &&  v.P_Step[playerID] == 200)
        if _t9(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            # (Line 51) {
            # (Line 52) s.CharacterVoice(3);
            s.CharacterVoice(3)
            # (Line 53) v.P_SkillDelay[playerID] = 0;
            _ARRW(v.P_SkillDelay, playerID) << (0)
            # (Line 54) v.P_Step[playerID] = 210;
            _ARRW(v.P_Step, playerID) << (210)
            # (Line 55) KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 56) }
            DoActions(KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 57) else if (Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill")
        _t10 = EUDElseIf()
        # (Line 58) && Bring(playerID, AtLeast, 2,"Protoss Carrier", "[Skill]UseSkill")
        # (Line 59) && v.P_Step[playerID] == 300)
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)()):
            ...
            # (Line 65) KillUnitAt(2, "Protoss Carrier", "[Skill]UseSkill", playerID);
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 66) }
        ...
        _t11 = EUDElseIf()
        # (Line 68) && Bring(playerID, AtLeast, 1,"Protoss Carrier", "[Skill]UseSkill")
        ...
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 310)()):
            # (Line 70) {
            # (Line 71) s.CharacterVoice(7);
            s.CharacterVoice(7)
            # (Line 72) v.P_Step[playerID] = 320;
            ...
            # (Line 79) else if (Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill")
        _t12 = EUDElseIf()
        ...
        if _t12(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])(v.P_Step[playerID] == 300)()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                _ARRW(v.P_SkillDelay, playerID) << (0)
                # (Line 90) v.P_CountSub1[playerID] = 0;
                ...
                # (Line 95) {
            if EUDElse()():
                # (Line 96) SetResources(CurrentPlayer, Add, 900, Gas);
