    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 0):
                # (Line 15) {
                # (Line 16) trg.Shape_Edge(playerID,1,"50 + 1n Tank",45,3,64);
                trg.Shape_Edge(playerID, 1, "50 + 1n Tank", 45, 3, 64)
                # (Line 17) trg.MoveLoc(v.P_UnitID[playerID],playerID,0,0);
                trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0)
                # (Line 18) Order("50 + 1n Tank",playerID,"Anywhere",Attack,v.P_LocationID[playerID]);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 1):
                # (Line 22) {
                # (Line 23) trg.Shape_Edge(playerID,1,"60 + 1n Danimoth",45,3,64);
                trg.Shape_Edge(playerID, 1, "60 + 1n Danimoth", 45, 3, 64)
                # (Line 24) trg.MoveLoc(v.P_UnitID[playerID],playerID,0,0);
                trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0)
                # (Line 25) Order("60 + 1n Danimoth",playerID,"Anywhere",Attack,v.P_LocationID[playerID]);
