...
# (Line 3) function SetBuildingHP(playerID)
# (Line 4) {
@EUDFunc
def SetBuildingHP(playerID):
    # (Line 5) ModifyUnitHitPoints(1, (155), (13), (64), 100 - (v.P_UniqueCool[playerID] / 10));
    # (Line 6) ModifyUnitShields(1, (167), (13), (64), dwread_epd(EPD(0x58A364 + 48 * 205 + 4 * playerID)) / 10);
    ...
    # (Line 9) function SetVariable(playerID)

# (Line 10) {
@EUDFunc
def SetVariable(playerID):
    # (Line 11) v.P_Potion[playerID] = dwread_epd(EPD(0x58A364 + 48 * 219 + 4 * playerID));
    _ARRW(v.P_Potion, playerID) << (f_dwread_epd(EPD(0x58A364 + 48 * 219 + 4 * playerID)))
    # (Line 12) v.EXP_Need[playerID] = dwread_epd(EPD(0x58A364 + 48 * 225 + 4 * playerID));
    _ARRW(v.EXP_Need, playerID) << (f_dwread_epd(EPD(0x58A364 + 48 * 225 + 4 * playerID)))
    # (Line 13) v.EXP_Now[playerID] = dwread_epd(EPD(0x58A364 + 48 * 185 + 4 * playerID));
    _ARRW(v.EXP_Now, playerID) << (f_dwread_epd(EPD(0x58A364 + 48 * 185 + 4 * playerID)))
    # (Line 15) v.P_DeathTime[playerID] = dwread_epd(EPD(0x58A364 + 48 * 210 + 4 * playerID))/12;
    _ARRW(v.P_DeathTime, playerID) << (f_dwread_epd(EPD(0x58A364 + 48 * 210 + 4 * playerID)) // 12)
    # (Line 16) v.P_UniqueCool[playerID] = dwread_epd(EPD(0x58A364 + 48 * 203 + 4 * playerID))/12;
    _ARRW(v.P_UniqueCool, playerID) << (f_dwread_epd(EPD(0x58A364 + 48 * 203 + 4 * playerID)) // 12)
    # (Line 17) v.P_UltimateGauge[playerID] = dwread_epd(EPD(0x58A364 + 48 * 205 + 4 * playerID));
    _ARRW(v.P_UltimateGauge, playerID) << (f_dwread_epd(EPD(0x58A364 + 48 * 205 + 4 * playerID)))
    # (Line 18) v.P_UniqueCondition[playerID] = dwread_epd(EPD(0x58A364 + 48 * 128 + 4 * playerID));
