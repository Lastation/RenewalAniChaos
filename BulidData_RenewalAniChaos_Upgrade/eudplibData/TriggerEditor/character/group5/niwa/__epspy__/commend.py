...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        _t10 = EUDElseIf()
        # (Line 66) && Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill")
        # (Line 67) && v.P_Step[playerID] == 200)
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            # (Line 68) {
            ...
            # (Line 76) }
            DoActions(KillUnitAt(1, "Protoss Scout", "[Skill]UseSkill", playerID))
            # (Line 79) else if (Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill")
        _t11 = EUDElseIf()
        ...
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                # (Line 96) {
            if EUDElse()():
                # (Line 97) SetResources(CurrentPlayer, Add, 600, Gas);
