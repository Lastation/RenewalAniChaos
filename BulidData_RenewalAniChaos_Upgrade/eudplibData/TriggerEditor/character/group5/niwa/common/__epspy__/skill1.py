    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] >= 11, neg=True):
                ...
                # (Line 15) if (v.P_LoopMain[playerID] == 11)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] == 11):
                # (Line 16) {
                # (Line 17) trg.Shape_Dot(playerID, 1, "Target", 0, 0);
                trg.Shape_Dot(playerID, 1, "Target", 0, 0)
                # (Line 18) trg.Shape_Dot(playerID, 1, "60 + 1n Archon", 0, 0);
                ...
                # (Line 22) if (v.P_LoopMain[playerID] == 12)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] == 12):
                # (Line 23) {
                # (Line 24) trg.Shape_Dot(playerID, 1, "Kakaru (Twilight)", 0, 0);
                ...
                # (Line 28) if (v.P_LoopMain[playerID] == 25)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] == 25):
                # (Line 29) {
                # (Line 30) trg.Shape_NxNSquare(playerID, 1, "40 + 1n Gantrithor", 3, 100);
                trg.Shape_NxNSquare(playerID, 1, "40 + 1n Gantrithor", 3, 100)
                # (Line 31) trg.Shape_NxNSquare(playerID, 1, "60 + 1n Archon", 3, 100);
                trg.Shape_NxNSquare(playerID, 1, "60 + 1n Archon", 3, 100)
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 1):
            # (Line 48) {
            # (Line 49) SetDeaths(playerID, SetTo, 1440, " `UniqueCoolTime");
            # (Line 50) SetDeaths(playerID, SetTo, 240, " `UniqueSkill");
            DoActions(SetDeaths(playerID, SetTo, 1440, " `UniqueCoolTime"))
            # (Line 51) trg.SkillEnd();
            DoActions(SetDeaths(playerID, SetTo, 240, " `UniqueSkill"))
            trg.SkillEnd()
            # (Line 52) }
            # (Line 53) }
        EUDEndIf()
