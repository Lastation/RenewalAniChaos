    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] >= 11, neg=True):
                ...
                # (Line 16) if (v.P_LoopMain[playerID] == 11)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] == 11):
                # (Line 17) {
                # (Line 18) trg.Shape_Dot(playerID, 1, "Target", 0, 0);
                trg.Shape_Dot(playerID, 1, "Target", 0, 0)
                # (Line 19) trg.Shape_Dot(playerID, 1, "60 + 1n Archon", 0, 0);
                ...
                # (Line 23) if (v.P_LoopMain[playerID] == 12)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] == 12):
                # (Line 24) {
                # (Line 25) trg.Shape_Dot(playerID, 1, "Kakaru (Twilight)", 0, 0);
                ...
                # (Line 29) if (v.P_LoopMain[playerID] == 25)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] == 25):
                # (Line 30) {
                # (Line 31) trg.Shape_NxNSquare(playerID, 1, "40 + 1n Gantrithor", 3, 100);
                trg.Shape_NxNSquare(playerID, 1, "40 + 1n Gantrithor", 3, 100)
                # (Line 32) trg.Shape_NxNSquare(playerID, 1, "60 + 1n Archon", 3, 100);
            ...
            # (Line 42) if (v.P_LoopMain[playerID] == 26)
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 1):
            # (Line 49) {
            # (Line 50) SetDeaths(playerID, SetTo, 1440, " `UniqueCoolTime");
            # (Line 51) SetDeaths(playerID, SetTo, 240, " `UniqueSkill");
