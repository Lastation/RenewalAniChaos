...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] == 0)(v.P_Step[playerID] == 0)()):
        ...
        if EUDElseIf()(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill")):
            # (Line 28) {
            # (Line 29) RemoveUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID);
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            ...
            _ARRW(v.P_LoopMain, playerID) << (0)
            # (Line 59) v.P_Step[playerID] = 230;
            _ARRW(v.P_Step, playerID) << (230)
            # (Line 60) KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 61) }
            DoActions(KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 62) else if (Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill")
        _t10 = EUDElseIf()
        # (Line 63) && v.P_Step[playerID] == 230)
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 230)()):
            # (Line 64) {
            # (Line 65) s.CharacterVoice(8);
            s.CharacterVoice(8)
        ...
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            # (Line 75) {
            # (Line 76) s.CharacterVoice(3);
            s.CharacterVoice(3)
            ...
            _ARRW(v.P_LoopMain, playerID) << (0)
            # (Line 80) v.P_Step[playerID] = 210;
            _ARRW(v.P_Step, playerID) << (210)
            # (Line 81) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID);
