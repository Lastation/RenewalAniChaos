    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 0):
                # (Line 12) {
                # (Line 13) trg.Shape_Edge(playerID, 1, "40 + 1n Mutalisk", 0, 3, 50);
                trg.Shape_Edge(playerID, 1, "40 + 1n Mutalisk", 0, 3, 50)
                # (Line 14) trg.Shape_Edge(playerID, 1, "Protoss Dark Archon", 0, 3, 50);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 1):
                # (Line 23) {
                # (Line 24) trg.Shape_Edge(playerID, 1, "40 + 1n Guardian", 0, 5, 100);
                trg.Shape_Edge(playerID, 1, "40 + 1n Guardian", 0, 5, 100)
                # (Line 25) trg.Shape_Edge(playerID, 1, "40 + 1n Marine", 0, 3, 100);
                trg.Shape_Edge(playerID, 1, "40 + 1n Marine", 0, 3, 100)
                # (Line 26) trg.Shape_Edge(playerID, 1, "50 + 1n Tank", 0, 5, 100);
                trg.Shape_Edge(playerID, 1, "50 + 1n Tank", 0, 5, 100)
                # (Line 27) trg.Shape_Edge(playerID, 1, "Kakaru (Twilight)", 0, 3, 50);
                ...
                # (Line 30) MoveUnit(All, "40 + 1n Marine", playerID, "[Skill]Unit_Wait_ALL", v.P_LocationID[playerID]);
                DoActions(MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere"))
                # (Line 31) Order("40 + 1n Marine", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
                DoActions(MoveUnit(All, "40 + 1n Marine", playerID, "[Skill]Unit_Wait_ALL", v.P_LocationID[playerID]))
                # (Line 33) KillUnitAt(All, "40 + 1n Guardian", "Anywhere", playerID);
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 1):
            # (Line 44) {
            # (Line 45) if (v.P_LoopMain[playerID] < 2)
            if EUDIf()(v.P_LoopMain[playerID] >= 2, neg=True):
                ...
                y = EUDVariable()
                y << (0)
                # (Line 50) if (v.P_LoopMain[playerID] == 0) { x = 150; y = 100; }
                if EUDIf()(v.P_LoopMain[playerID] == 0):
                    x << (150)
                    y << (100)
                    # (Line 51) else if (v.P_LoopMain[playerID] == 1) { x = 100; y = 50; }
                if EUDElseIf()(v.P_LoopMain[playerID] == 1):
                    x << (100)
                    y << (50)
                    # (Line 53) trg.Shape_Square(playerID, 1, "40 + 1n Guardian", x, y);
                EUDEndIf()
                trg.Shape_Square(playerID, 1, "40 + 1n Guardian", x, y)
                # (Line 54) trg.Shape_Square(playerID, 1, "40 + 1n Guardian", y, x);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 2):
                # (Line 63) {
                # (Line 64) KillUnitAt(All, "40 + 1n Marine", "Anywhere", playerID);
                # (Line 66) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 100);
                DoActions(KillUnitAt(All, "40 + 1n Marine", "Anywhere", playerID))
                trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 100)
                # (Line 67) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 100, 50);
                trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 100, 50)
                # (Line 68) trg.Shape_Square(playerID, 1, " Unit. Hoffnung 25000", 50, 100);
                trg.Shape_Square(playerID, 1, " Unit. Hoffnung 25000", 50, 100)
                # (Line 69) trg.Shape_Square(playerID, 1, " Unit. Hoffnung 25000", 100, 50);
                ...
                # (Line 72) Order("40 + 1n Wraith", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
                DoActions(MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere"))
                ...
                _ARRW(v.P_LoopMain, playerID).__iadd__(1)
                # (Line 80) }
                # (Line 81) else if (v.P_LoopMain[playerID] == 3)
            if EUDElseIf()(v.P_LoopMain[playerID] == 3):
                # (Line 82) {
                # (Line 83) KillUnitAt(All, "40 + 1n Wraith", "Anywhere", playerID);
                # (Line 85) trg.Shape_Square(playerID, 1, "Kakaru (Twilight)", 50, 100);
                DoActions(KillUnitAt(All, "40 + 1n Wraith", "Anywhere", playerID))
                trg.Shape_Square(playerID, 1, "Kakaru (Twilight)", 50, 100)
                # (Line 86) trg.Shape_Square(playerID, 1, "Kakaru (Twilight)", 100, 50);
                trg.Shape_Square(playerID, 1, "Kakaru (Twilight)", 100, 50)
                # (Line 87) trg.Shape_Square(playerID, 1, " Unit. Hoffnung 25000", 50, 100);
                trg.Shape_Square(playerID, 1, " Unit. Hoffnung 25000", 50, 100)
                # (Line 88) trg.Shape_Square(playerID, 1, " Unit. Hoffnung 25000", 100, 50);
                trg.Shape_Square(playerID, 1, " Unit. Hoffnung 25000", 100, 50)
                # (Line 90) KillUnitAt(All, " Unit. Hoffnung 25000", "Anywhere", playerID);
