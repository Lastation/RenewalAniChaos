...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if EUDIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 100)()):
            ...
            # (Line 59) else if (Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill") &&  v.P_Step[playerID] == 200)
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            # (Line 60) {
            # (Line 61) s.CharacterVoice(1);
            s.CharacterVoice(1)
            # (Line 62) v.P_SkillDelay[playerID] = 0;
            _ARRW(v.P_SkillDelay, playerID) << (0)
            # (Line 63) v.P_Step[playerID] = 210;
            _ARRW(v.P_Step, playerID) << (210)
            # (Line 64) KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 65) }
            DoActions(KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 68) else if (Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill")
        _t11 = EUDElseIf()
        # (Line 69) && v.P_Step[playerID] == 300
        # (Line 70) && v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                # (Line 81) SetSwitch("Recall - Chtholly", Set);
