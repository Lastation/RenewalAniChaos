...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        # (Line 8) {
        # (Line 9) if(v.P_CountMain[playerID] == 0 || v.P_CountMain[playerID] == 5 || v.P_CountMain[playerID] == 10)
        if EUDIf()(EUDSCOr()(v.P_CountMain[playerID] == 0)(v.P_CountMain[playerID] == 5)(v.P_CountMain[playerID] == 10)()):
            # (Line 10) {
            # (Line 11) trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 128, 128);
            trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 128, 128)
            # (Line 12) trg.Shape_Square(playerID, 1, "40 + 1n Zergling", 64, 64);
            trg.Shape_Square(playerID, 1, "40 + 1n Zergling", 64, 64)
            # (Line 13) KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", playerID);
            # (Line 14) KillUnitAt(All, "40 + 1n Zergling", "Anywhere", playerID);
            ...
            # (Line 17) }
            # (Line 18) else if(v.P_CountMain[playerID] == 1 || v.P_CountMain[playerID] == 6 || v.P_CountMain[playerID] == 11)
        if EUDElseIf()(EUDSCOr()(v.P_CountMain[playerID] == 1)(v.P_CountMain[playerID] == 6)(v.P_CountMain[playerID] == 11)()):
            # (Line 19) {
            # (Line 20) trg.Shape_Square(playerID, 1, "Kakaru", 64, 0);
            trg.Shape_Square(playerID, 1, "Kakaru", 64, 0)
            # (Line 21) trg.Shape_Square(playerID, 1, "40 + 1n Zealot", 128, 0);
            trg.Shape_Square(playerID, 1, "40 + 1n Zealot", 128, 0)
            # (Line 22) KillUnitAt(All, "Kakaru", "Anywhere", playerID);
            ...
            _ARRW(v.P_CountMain, playerID).__iadd__(1)
            # (Line 26) }
            # (Line 27) else if(v.P_CountMain[playerID] == 2 || v.P_CountMain[playerID] == 7 || v.P_CountMain[playerID] == 12)
        if EUDElseIf()(EUDSCOr()(v.P_CountMain[playerID] == 2)(v.P_CountMain[playerID] == 7)(v.P_CountMain[playerID] == 12)()):
            # (Line 28) {
            # (Line 29) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 64, 64);
            trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 64, 64)
            # (Line 30) trg.Shape_Square(playerID, 1, "50 + 1n Tank", 64, 64);
            trg.Shape_Square(playerID, 1, "50 + 1n Tank", 64, 64)
            # (Line 31) KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID);
            ...
            # (Line 34) trg.Main_Wait(60);
            DoActions(Order("40 + 1n Wraith", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
            trg.Main_Wait(60)
            # (Line 35) v.P_CountMain[playerID] += 1;
            _ARRW(v.P_CountMain, playerID).__iadd__(1)
            # (Line 36) }
            # (Line 37) else if(v.P_CountMain[playerID] == 3 || v.P_CountMain[playerID] == 8 || v.P_CountMain[playerID] == 13)
        if EUDElseIf()(EUDSCOr()(v.P_CountMain[playerID] == 3)(v.P_CountMain[playerID] == 8)(v.P_CountMain[playerID] == 13)()):
            ...
            # (Line 41) trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 128, 0);
            DoActions(KillUnitAt(All, "40 + 1n Wraith", "Anywhere", playerID))
            trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 128, 0)
            # (Line 42) trg.Shape_Square(playerID, 1, "60 + 1n Archon", 128, 0);
            ...
            DoActions(MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere"))
            # (Line 46) trg.Main_Wait(50);
            DoActions(Order("40 + 1n Mojo", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
            trg.Main_Wait(50)
            # (Line 47) v.P_CountMain[playerID] += 1;
            _ARRW(v.P_CountMain, playerID).__iadd__(1)
            # (Line 48) }
            # (Line 49) else if(v.P_CountMain[playerID] == 4 || v.P_CountMain[playerID] == 9 || v.P_CountMain[playerID] == 14)
        if EUDElseIf()(EUDSCOr()(v.P_CountMain[playerID] == 4)(v.P_CountMain[playerID] == 9)(v.P_CountMain[playerID] == 14)()):
            ...
            # (Line 54) trg.Shape_Square(playerID, 1, "50 + 1n Battlecruiser", 64, 0);
            DoActions(KillUnitAt(All, "40 + 1n Mojo", "Anywhere", playerID))
            trg.Shape_Square(playerID, 1, "50 + 1n Battlecruiser", 64, 0)
            # (Line 55) trg.Shape_Square(playerID, 1, "Torrasque", 64, 0);
            ...
            _ARRW(v.P_CountMain, playerID).__iadd__(1)
            # (Line 60) }
            # (Line 61) else if(v.P_CountMain[playerID] == 15)
        if EUDElseIf()(v.P_CountMain[playerID] == 15):
            # (Line 62) {
            # (Line 63) MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere");
            # (Line 64) trg.SkillUnit(playerID, 1, "40 + 1n Mutalisk");
            DoActions(MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere"))
            trg.SkillUnit(playerID, 1, "40 + 1n Mutalisk")
            # (Line 65) trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 32, 0);
            trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 32, 0)
            # (Line 66) trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 64, 0);
            trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 64, 0)
            # (Line 67) trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 96, 0);
            trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 96, 0)
            # (Line 68) trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 128, 0);
            trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 128, 0)
            # (Line 69) trg.Shape_Square(playerID, 1, "Torrasque", 32, 32);
            trg.Shape_Square(playerID, 1, "Torrasque", 32, 32)
            # (Line 70) trg.Shape_Square(playerID, 1, "Torrasque", 64, 64);
            trg.Shape_Square(playerID, 1, "Torrasque", 64, 64)
            # (Line 71) trg.Shape_Square(playerID, 1, "Torrasque", 96, 64);
            trg.Shape_Square(playerID, 1, "Torrasque", 96, 64)
            # (Line 72) KillUnitAt(All, "Torrasque", "Anywhere", playerID);
