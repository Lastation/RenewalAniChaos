...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            ...
            # (Line 54) KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 55) SetSwitch("Recall - Rusalka", Set);
            DoActions(KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 56) }
            DoActions(SetSwitch("Recall - Rusalka", Set))
            # (Line 57) else if (Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill")
        _t10 = EUDElseIf()
        # (Line 58) && Accumulate(playerID, AtLeast, 200, Gas)
        # (Line 59) && v.P_Step[playerID] == 210)
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(Accumulate(playerID, AtLeast, 200, Gas))(v.P_Step[playerID] == 210)()):
            # (Line 60) {
            # (Line 61) s.CharacterVoice(3);
            s.CharacterVoice(3)
            # (Line 62) v.P_SkillDelay[playerID] = 0;
            _ARRW(v.P_SkillDelay, playerID) << (0)
            # (Line 63) SetResources(playerID, Subtract, 200, Gas);
            # (Line 64) v.P_Step[playerID] = 220;
            DoActions(SetResources(playerID, Subtract, 200, Gas))
            _ARRW(v.P_Step, playerID) << (220)
            # (Line 65) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID);
            # (Line 66) SetSwitch("Recall - Rusalka", Set);
            DoActions(KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 67) }
            DoActions(SetSwitch("Recall - Rusalka", Set))
            # (Line 68) else if (Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill")&&
        _t11 = EUDElseIf()
        ...
        _t12 = EUDElseIf()
        # (Line 81) && Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill")
        ...
        if _t12(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])(v.P_Step[playerID] == 300)()):
            # (Line 84) {
            # (Line 85) if (Switch("UiltimateSwitch", Cleared))
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                # (Line 86) {
                # (Line 87) s.CharacterVoice(5);
                s.CharacterVoice(5)
                # (Line 88) SetSwitch("UiltimateSwitch", Set);
