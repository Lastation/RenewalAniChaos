    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 0):
                # (Line 11) {
                # (Line 12) trg.Shape_Square(playerID, 1, "50 + 1n Tank", 100, 0);
                trg.Shape_Square(playerID, 1, "50 + 1n Tank", 100, 0)
                # (Line 13) KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID);
                # (Line 14) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 100, 100);
                ...
                # (Line 16) Order("40 + 1n Wraith", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 2):
                ...
                # (Line 22) trg.Shape_Square(playerID, 1, "50 + 1n Tank", 100, 100);
                ...
                # (Line 24) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 100, 0);
                DoActions(KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID))
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 4):
                # (Line 29) {
                # (Line 30) KillUnitAt(All, "40 + 1n Wraith", "Anywhere", playerID);
                # (Line 32) trg.Shape_Square(playerID, 1, "50 + 1n Tank", 50, 0);
                DoActions(KillUnitAt(All, "40 + 1n Wraith", "Anywhere", playerID))
                trg.Shape_Square(playerID, 1, "50 + 1n Tank", 50, 0)
                # (Line 33) KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID);
                # (Line 34) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 50);
                DoActions(KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID))
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 6):
                ...
                # (Line 43) KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID);
                # (Line 44) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 0);
                DoActions(KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID))
