...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            # (Line 9) {
            # (Line 10) if (v.P_LoopMain[playerID] < 12)
            if EUDIf()(v.P_LoopMain[playerID] >= 12, neg=True):
                # (Line 11) {
                # (Line 12) trg.Shape_Square(playerID, 1, "Bengalaas (Jungle)", 32, 32);
                trg.Shape_Square(playerID, 1, "Bengalaas (Jungle)", 32, 32)
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 1):
            # (Line 27) {
            # (Line 28) if (v.P_LoopMain[playerID] < 12 )
            if EUDIf()(v.P_LoopMain[playerID] >= 12, neg=True):
                # (Line 29) {
                # (Line 30) trg.Shape_Square(playerID, 1, "Bengalaas (Jungle)", 64, 64);
                trg.Shape_Square(playerID, 1, "Bengalaas (Jungle)", 64, 64)
                # (Line 31) trg.Shape_Square(playerID, 1, "Protoss Dark Archon", 64, 0);
                trg.Shape_Square(playerID, 1, "Protoss Dark Archon", 64, 0)
                # (Line 32) KillUnitAt(All, "Bengalaas (Jungle)", "Anywhere", playerID);
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 12):
                ...
                # (Line 45) }
            EUDEndIf()
            # (Line 47) else if (v.P_CountMain[playerID] == 2)
        if EUDElseIf()(v.P_CountMain[playerID] == 2):
            # (Line 48) {
            # (Line 49) if (v.P_LoopMain[playerID] == 8 )
            if EUDIf()(v.P_LoopMain[playerID] == 8):
                # (Line 50) {
                # (Line 51) trg.Shape_NxNSquare(playerID, 1, "50 + 1n Battlecruiser", 3, 100);
                trg.Shape_NxNSquare(playerID, 1, "50 + 1n Battlecruiser", 3, 100)
                # (Line 52) trg.Shape_NxNSquare(playerID, 1, "Protoss Dark Archon", 3, 50);
            ...
            _ARRW(v.P_LoopMain, playerID).__iadd__(1)
            # (Line 60) if (v.P_LoopMain[playerID] == 10)
            if EUDIf()(v.P_LoopMain[playerID] == 10):
                ...
                # (Line 65) }
            EUDEndIf()
            # (Line 67) else if (v.P_CountMain[playerID] == 3)
        if EUDElseIf()(v.P_CountMain[playerID] == 3):
            # (Line 68) {
            # (Line 69) SetDeaths(playerID, SetTo, 1200, " `UniqueCoolTime");
            # (Line 70) SetDeaths(playerID, SetTo, 120, " `UniqueSkill");
            DoActions(SetDeaths(playerID, SetTo, 1200, " `UniqueCoolTime"))
