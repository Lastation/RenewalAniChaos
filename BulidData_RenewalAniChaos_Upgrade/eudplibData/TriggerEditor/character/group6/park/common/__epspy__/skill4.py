...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            # (Line 10) {
            # (Line 11) KillUnitAt(All, "Protoss Dark Archon", "Anywhere", playerID);
            # (Line 12) if (v.P_LoopMain[playerID] == 0)
            DoActions(KillUnitAt(All, "Protoss Dark Archon", "Anywhere", playerID))
            if EUDIf()(v.P_LoopMain[playerID] == 0):
                # (Line 13) {
                # (Line 14) trg.Shape_Square(playerID, 1, "50 + 1n Battlecruiser", 100, 0);
                trg.Shape_Square(playerID, 1, "50 + 1n Battlecruiser", 100, 0)
                # (Line 15) trg.Shape_Square(playerID, 1, "50 + 1n Battlecruiser", 100, 100);
                ...
                # (Line 17) Order("50 + 1n Battlecruiser", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 2):
                # (Line 20) {
                # (Line 21) KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID);
                # (Line 22) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 0);
                DoActions(KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID))
                trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 0)
                # (Line 23) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 50);
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 4):
                # (Line 28) {
                # (Line 29) KillUnitAt(All, "40 + 1n Wraith", "Anywhere", playerID);
                # (Line 30) trg.Shape_Square(playerID, 1, "50 + 1n Battlecruiser", 100, 0);
                ...
                # (Line 34) }
                DoActions(Order("50 + 1n Battlecruiser", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
                # (Line 35) if (v.P_LoopMain[playerID] == 6)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] == 6):
                # (Line 36) {
                # (Line 37) KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID);
                # (Line 38) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 0);
                DoActions(KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID))
                trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 0)
                # (Line 39) trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 50);
                trg.Shape_Square(playerID, 1, "40 + 1n Wraith", 50, 50)
                # (Line 40) MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere");
                # (Line 41) }
                DoActions(MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere"))
                # (Line 42) if (v.P_LoopMain[playerID] < 7)
            EUDEndIf()
            if EUDIf()(v.P_LoopMain[playerID] >= 7, neg=True):
                # (Line 43) {
                # (Line 44) trg.Shape_Square(playerID, 1, "Protoss Dark Archon", -100, 100 - 50 * v.P_LoopMain[playerID]);
