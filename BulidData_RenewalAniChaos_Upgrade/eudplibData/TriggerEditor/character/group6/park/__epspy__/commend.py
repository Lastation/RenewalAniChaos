...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 210)(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))()):
            ...
            # (Line 73) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 74) else if (Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill") &&
        _t11 = EUDElseIf()
        # (Line 75) Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill") && v.P_Step[playerID] == 220)
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 220)()):
            # (Line 76) {
            ...
            # (Line 83) KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID);
            DoActions(KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 84) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
