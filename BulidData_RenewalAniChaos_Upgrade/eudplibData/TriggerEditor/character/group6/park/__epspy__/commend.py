...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if EUDIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 100)()):
            ...
            # (Line 53) else if (Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill") && v.P_Step[playerID] == 200
        _t9 = EUDElseIf()
        # (Line 54) && Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))
        if _t9(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))()):
            ...
            # (Line 63) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 64) else if (Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill") && v.P_Step[playerID] == 210
        _t10 = EUDElseIf()
        ...
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 210)(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))()):
            ...
            # (Line 74) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 75) else if (Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill") && v.P_Step[playerID] == 220)
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 220)()):
            # (Line 76) {
            # (Line 77) s.CharacterVoice(8);
            s.CharacterVoice(8)
            ...
            # (Line 84) else if (Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill") && v.P_Step[playerID] == 300
        _t12 = EUDElseIf()
        # (Line 85) && Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))
        if _t12(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))()):
            ...
            _ARRW(v.P_LoopMain, playerID) << (0)
            # (Line 91) v.P_Step[playerID] = 310;
            _ARRW(v.P_Step, playerID) << (310)
            # (Line 92) KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 93) KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID);
            DoActions(KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 94) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
        ...
        if _t13(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])()):
            # (Line 101) {
            # (Line 102) s.CharacterVoice(1);
            s.CharacterVoice(1)
            # (Line 103) v.P_SkillDelay[playerID] = 0;
            _ARRW(v.P_SkillDelay, playerID) << (0)
            # (Line 104) v.P_Step[playerID] = 320;
            _ARRW(v.P_Step, playerID) << (320)
            # (Line 105) SetDeaths(playerID, Subtract, v.P_Ultimate1[playerID], " `UltimateCoolTime");
            ...
            # (Line 109) else if (Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill")
        _t14 = EUDElseIf()
        ...
        if _t14(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 320)(v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])()):
            # (Line 112) {
            # (Line 113) if (Switch("UiltimateSwitch", Cleared))
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                # (Line 121) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID);
