...
def SkillList(playerID):
    ...
    if EUDIf()(Memory(0x00596A44, Exactly, 256)):
        ...
        # (Line 31) v.stb.printAt(3, "　　　\x18O \x04택견 - 무음신속 \x19[ 10초 간 첫 스킬에 한해 스킬 사용시 적에게 돌진 ] \x051분");
        v.stb.printAt(3, "　　　\x18O \x04택견 - 무음신속 \x19[ 10초 간 첫 스킬에 한해 스킬 사용시 적에게 돌진 ] \x051분")
        ...
        # (Line 35) v.stb.printAt(7, "　　　\x08AAA \x04택견 오의 - 화축 \x19[ 대인 / 쉴드고정 20 ] \x05", v.P_Ultimate1[playerID]);
        v.stb.printAt(7, "　　　\x08AAA \x04택견 오의 - 화축 \x19[ 대인 / 쉴드고정 20 ] \x05", v.P_Ultimate1[playerID])
        # (Line 36) v.stb.printAt(8, "　　　\x08 + AA \x04 최종 오의 - 삼염멸도각 \x19[ 공성 / 쉴드고정 1 / 플레이어동맹] \x05", v.P_Ultimate2[playerID]);
        v.stb.printAt(8, "　　　\x08 + AA \x04 최종 오의 - 삼염멸도각 \x19[ 공성 / 쉴드고정 1 / 플레이어동맹] \x05", v.P_Ultimate2[playerID])
