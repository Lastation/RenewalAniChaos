...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            # (Line 10) {
            # (Line 11) KillUnitAt(All,"50 + 1n Tank" , "Anywhere", playerID);
            ...
            if EUDIf()(v.P_LoopMain[playerID] == 0):
                # (Line 15) {
                # (Line 16) trg.Shape_NxNSquare(playerID,1,"50 + 1n Tank",2,64);
                trg.Shape_NxNSquare(playerID, 1, "50 + 1n Tank", 2, 64)
                # (Line 17) trg.Shape_NxNSquare(playerID,1,"40 + 1n Mojo",2,64);
                ...
                # (Line 19) Order("50 + 1n Tank",playerID,"Anywhere",Attack,v.P_LocationID[playerID]);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 2):
                # (Line 30) {
                # (Line 31) trg.Shape_NxNSquare(playerID,1,"50 + 1n Tank",3,64);
                trg.Shape_NxNSquare(playerID, 1, "50 + 1n Tank", 3, 64)
                # (Line 32) trg.Shape_NxNSquare(playerID,1,"40 + 1n Mojo",3,64);
