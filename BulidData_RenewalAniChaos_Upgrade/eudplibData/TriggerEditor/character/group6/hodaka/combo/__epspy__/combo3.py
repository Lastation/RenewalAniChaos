    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] <= 46):
                # (Line 109) {
                # (Line 110) adv.Shape_NxNSquareAt(playerID,"Kakaru", 1, "50 + 1n Tank", 3, 64);
                adv.Shape_NxNSquareAt(playerID, "Kakaru", 1, "50 + 1n Tank", 3, 64)
                # (Line 111) adv.Shape_NxNSquareAt(playerID,"Kakaru", 1, "50 + 1n Battlecruiser", 3, 64);
                adv.Shape_NxNSquareAt(playerID, "Kakaru", 1, "50 + 1n Battlecruiser", 3, 64)
                # (Line 112) RemoveUnitAt(1,"Kakaru","Anywhere",playerID);
                # (Line 113) Order("50 + 1n Tank", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
                DoActions(RemoveUnitAt(1, "Kakaru", "Anywhere", playerID))
                # (Line 114) Order("50 + 1n Battlecruiser", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
                DoActions(Order("50 + 1n Tank", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
                # (Line 115) trg.Main_Wait(200);
                DoActions(Order("50 + 1n Battlecruiser", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
                trg.Main_Wait(200)
                # (Line 116) }
                # (Line 118) else if(v.P_LoopMain[playerID] == 47)
            if EUDElseIf()(v.P_LoopMain[playerID] == 47):
                ...
                DoActions(KillUnitAt(All, "50 + 1n Tank", "Anywhere", playerID))
                # (Line 122) trg.Shape_NxNSquare(playerID,1,"100 + 1n Hyperion",3,256);
                DoActions(KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID))
                trg.Shape_NxNSquare(playerID, 1, "100 + 1n Hyperion", 3, 256)
                # (Line 123) trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0);
                trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0)
                # (Line 124) Order("100 + 1n Hyperion", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
                # (Line 125) trg.Main_Wait(200);
                DoActions(Order("100 + 1n Hyperion", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
                trg.Main_Wait(200)
                # (Line 126) }
                # (Line 128) else if(v.P_LoopMain[playerID] == 52)
