...
# (Line 14) import character.group6.endeavor.combo.combo4 as AACCAAA;
from character.group6.endeavor.combo import combo4 as AACCAAA
...
def f_skillList(playerID):
    ...
    if EUDIf()(Memory(0x00596A44, Exactly, 256)):
        ...
        # (Line 27) v.stb.printAt(6, "　　　\x04\x1FAACC(+200 Gas 소모) + AAA \x04최대출력 \x19[ 공성 ] \x1F[1]");
        v.stb.printAt(6, "　　　\x04\x1FAACC(+200 Gas 소모) + AAA \x04최대출력 \x19[ 공성 ] \x1F[1]")
...
def f_main(playerID):
    ...
    if EUDIf()(v.P_SkillDelay[playerID] == 0):
        ...
        if _t8(310):
            ...
            # (Line 75) case 320:
        _t9 = EUDSwitchCase()
        # (Line 76) AACCAAA.main(playerID);
        if _t9(320):
            AACCAAA.f_main(playerID)
            # (Line 77) break;
            EUDBreak()
            # (Line 78) case 330:
        _t10 = EUDSwitchCase()
