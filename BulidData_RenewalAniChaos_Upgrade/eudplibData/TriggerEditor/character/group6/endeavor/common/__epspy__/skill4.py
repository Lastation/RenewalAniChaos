    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] <= 4):
                # (Line 15) {
                # (Line 16) trg.Shape_Line(playerID,1,"60 + 1n Danimoth",0+15*x,2,256,0);
                trg.Shape_Line(playerID, 1, "60 + 1n Danimoth", 0 + 15 * x, 2, 256, 0)
                # (Line 17) trg.Shape_Line(playerID,1,"60 + 1n Danimoth",90+15*x,2,256,0);
                trg.Shape_Line(playerID, 1, "60 + 1n Danimoth", 90 + 15 * x, 2, 256, 0)
                # (Line 18) trg.Shape_Line(playerID,1,"40 + 1n Goliath",90+15*x,2,256,0);
                trg.Shape_Line(playerID, 1, "40 + 1n Goliath", 90 + 15 * x, 2, 256, 0)
                # (Line 19) trg.Shape_Line(playerID,1,"60 + 1n Archon",0+15*x,2,256,0);
                trg.Shape_Line(playerID, 1, "60 + 1n Archon", 0 + 15 * x, 2, 256, 0)
                # (Line 20) trg.Shape_Line(playerID,1,"60 + 1n Archon",90+15*x,2,256,0);
                trg.Shape_Line(playerID, 1, "60 + 1n Archon", 90 + 15 * x, 2, 256, 0)
                # (Line 21) trg.Shape_Dot(playerID,1,"60 + 1n Danimoth",0,0);
