...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        _t11 = EUDElseIf()
        # (Line 72) &&	Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill")
        # (Line 73) && Accumulate(playerID, AtLeast, 500, Gas)
        # (Line 74) &&  v.P_Step[playerID] == 300)
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(Accumulate(playerID, AtLeast, 500, Gas))(v.P_Step[playerID] == 300)()):
            # (Line 75) {
            ...
            _ARRW(v.P_SkillDelay, playerID) << (0)
            # (Line 79) SetResources(playerID, Subtract, 500, Gas);
            # (Line 80) KillUnitAt(2, "Protoss Carrier", "[Skill]UseSkill", playerID);
            DoActions(SetResources(playerID, Subtract, 500, Gas))
        ...
        if _t12(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                # (Line 97) CreateUnit(1, " Item. Flag", "[Uiltimate]Flag", CurrentPlayer);
                ...
                # (Line 99) KillUnitAt(3, "Protoss Arbiter", "[Skill]UseSkill", playerID);
