    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] >= 8, neg=True):
                # (Line 12) {
                # (Line 13) trg.Shape_Line(playerID, 1, "Kakaru (Twilight)", 45 * 3 * v.P_LoopMain[playerID], 7, 50, 50);
                trg.Shape_Line(playerID, 1, "Kakaru (Twilight)", 45 * 3 * v.P_LoopMain[playerID], 7, 50, 50)
                # (Line 14) trg.Shape_Line(playerID, 1, "Protoss Dark Templar", 45 * 3 * v.P_LoopMain[playerID], 7, 50, 50);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 8):
                ...
                # (Line 27) }
            EUDEndIf()
            # (Line 28) if (v.P_CountMain[playerID] == 1)
        EUDEndIf()
        if EUDIf()(v.P_CountMain[playerID] == 1):
            ...
            if EUDIf()(v.P_LoopMain[playerID] >= 2, neg=True):
                # (Line 31) {
                # (Line 32) RemoveUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 2):
                # (Line 40) {
                # (Line 41) RemoveUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID);
                # (Line 42) trg.Shape_NxNSquare(playerID, 1, " Unit. Hoffnung 25000", 3, 75);
                DoActions(RemoveUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID))
                trg.Shape_NxNSquare(playerID, 1, " Unit. Hoffnung 25000", 3, 75)
                # (Line 43) KillUnitAt(All, " Unit. Hoffnung 25000", "Anywhere", playerID);
