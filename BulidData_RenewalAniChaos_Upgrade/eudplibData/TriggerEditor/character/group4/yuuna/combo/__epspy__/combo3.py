...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 2):
            # (Line 116) {
            # (Line 117) if (Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill")
            _t10 = EUDIf()
            # (Line 118) && Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill")
            # (Line 119) && v.P_Step[playerID] == 210)
            if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 210)()):
                ...
                # (Line 124) v.P_CountMain[playerID] = 0;
                _ARRW(v.P_CountMain, playerID) << (0)
                # (Line 125) v.P_LoopMain[playerID] = 0;
                _ARRW(v.P_LoopMain, playerID) << (0)
                # (Line 126) v.P_Step[playerID] = 220;
                _ARRW(v.P_Step, playerID) << (220)
                # (Line 127) KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID);
                # (Line 128) KillUnitAt(1, "Protoss Scout", "[Skill]UseSkill", playerID);
