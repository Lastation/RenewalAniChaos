...
# (Line 4) import character.group4.yuuna.common.skill1 as O;
from character.group4.yuuna.common import skill1 as O
# (Line 5) import character.group4.yuuna.common.skill2 as S;
from character.group4.yuuna.common import skill2 as S
# (Line 6) import character.group4.yuuna.common.skill3 as C;
from character.group4.yuuna.common import skill3 as C
# (Line 7) import character.group4.yuuna.common.skill4 as A;
from character.group4.yuuna.common import skill4 as A
# (Line 9) import character.group4.yuuna.combo.combo1 as SSS;
from character.group4.yuuna.combo import combo1 as SSS
# (Line 10) import character.group4.yuuna.combo.combo2 as SSSSS;
from character.group4.yuuna.combo import combo2 as SSSSS
# (Line 11) import character.group4.yuuna.combo.combo3 as CCC;
from character.group4.yuuna.combo import combo3 as CCC
# (Line 12) import character.group4.yuuna.combo.combo4 as CCCAA;
from character.group4.yuuna.combo import combo4 as CCCAA
# (Line 13) import character.group4.yuuna.combo.combo5 as CAAA;
from character.group4.yuuna.combo import combo5 as CAAA
# (Line 15) import character.group4.yuuna.ultimate.ultimate1 as AAA;
from character.group4.yuuna.ultimate import ultimate1 as AAA
# (Line 16) import character.group4.yuuna.ultimate.ultimate2 as AAAAAA;
from character.group4.yuuna.ultimate import ultimate2 as AAAAAA
# (Line 18) import character.group4.yuuna.text as text;
from character.group4.yuuna import text as text
# (Line 19) import character.group4.yuuna.commend as commend;
...
def SkillList(playerID):
    ...
    if EUDIf()(Memory(0x00596A44, Exactly, 256)):
        ...
        v.stb.printAt(0, "\n")
        # (Line 26) v.stb.printAt(1, "\x1F　＃\x04- 유우키 \x1B유우나　\x04[ 유우키 유우나는 용사다 ]");
        ...
        # (Line 28) v.stb.printAt(3, "　　　\x18O \x04만개 \x19[ 공 3 업 방 3 다운 / 최대 3 중첩 가능 / 사망 시 해제 ] \x051분");
        v.stb.printAt(3, "　　　\x18O \x04만개 \x19[ 공 3 업 방 3 다운 / 최대 3 중첩 가능 / 사망 시 해제 ] \x051분")
        # (Line 29) v.stb.printAt(4, "　　　\x04\x1FSSS + AS \x04인간 \x19[ 대인 / 순간딜 / AS - 자리고정 ]");
        v.stb.printAt(4, "　　　\x04\x1FSSS + AS \x04인간 \x19[ 대인 / 순간딜 / AS - 자리고정 ]")
        # (Line 30) v.stb.printAt(5, "　　　\x04\x1FCC + AS \x04강인함 \x19[ 공성 / 순간딜 / 자리고정 ]");
        v.stb.printAt(5, "　　　\x04\x1FCC + AS \x04강인함 \x19[ 공성 / 순간딜 / 자리고정 ]")
        # (Line 31) v.stb.printAt(6, "　　　\x04\x1FCAAA + 100 Gas \x04희생 \x19[ 공성 / 지속딜 / 자리고정 ]");
        v.stb.printAt(6, "　　　\x04\x1FCAAA + 100 Gas \x04희생 \x19[ 공성 / 지속딜 / 자리고정 ]")
        # (Line 32) v.stb.printAt(7, "\n");
        v.stb.printAt(7, "\n")
        # (Line 33) v.stb.printAt(8, "　　　\x08AAAA \x04대만개 \x19[ 공성 ] \x05", v.P_Ultimate1[playerID]);
        v.stb.printAt(8, "　　　\x08AAAA \x04대만개 \x19[ 공성 ] \x05", v.P_Ultimate1[playerID])
        # (Line 34) v.stb.printAt(9, "　　　\x04+ \x08AAA \x04용사 펀치 \x19[ 만개 3 중첩 시 사용 가능 ] \x05", v.P_Ultimate2[playerID]);
