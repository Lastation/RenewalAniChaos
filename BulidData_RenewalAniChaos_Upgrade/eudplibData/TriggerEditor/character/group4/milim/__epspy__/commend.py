...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        _t9 = EUDElseIf()
        # (Line 54) && Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill") && v.P_Step[playerID] == 200)
        ...
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                _ARRW(v.P_LoopMain, playerID) << (0)
                # (Line 86) v.P_Step[playerID] = 310;
                _ARRW(v.P_Step, playerID) << (310)
                # (Line 87) SetDeaths(playerID, Subtract, v.P_Ultimate1[playerID], " `UltimateCoolTime");
                ...
                # (Line 91) {
            if EUDElse()():
                # (Line 92) SetResources(CurrentPlayer, Add, 900, Gas);
