    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 2):
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 1):
                ...
                # (Line 223) }
            EUDEndIf()
            # (Line 224) else if (Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill")
        _t26 = EUDElseIf()
        # (Line 225) && v.P_CountMain[playerID] == 3)
        if _t26(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill"))(v.P_CountMain[playerID] == 3)()):
            # (Line 226) {
            # (Line 227) s.CharacterVoice(8);
            s.CharacterVoice(8)
            # (Line 228) v.P_SkillDelay[playerID] = 0;
            _ARRW(v.P_SkillDelay, playerID) << (0)
            # (Line 229) v.P_CountMain[playerID] = 0;
            _ARRW(v.P_CountMain, playerID) << (0)
            # (Line 230) v.P_LoopMain[playerID] = 0;
            _ARRW(v.P_LoopMain, playerID) << (0)
            # (Line 231) v.P_Step[playerID] = 250;
            _ARRW(v.P_Step, playerID) << (250)
            # (Line 233) KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", playerID);
            # (Line 234) KillUnitAt(All, "60 + 1n Siege", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", playerID))
            # (Line 235) KillUnitAt(All, "40 + 1n Mojo", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "60 + 1n Siege", "Anywhere", playerID))
            # (Line 236) KillUnitAt(All, "60 + 1n High Templar", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "40 + 1n Mojo", "Anywhere", playerID))
            # (Line 237) SetSwitch("Passive - Nanami1", Clear);
            DoActions(KillUnitAt(All, "60 + 1n High Templar", "Anywhere", playerID))
            # (Line 238) SetSwitch("Passive - Nanami2", Clear);
            DoActions(SetSwitch("Passive - Nanami1", Clear))
            # (Line 241) KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID);
            DoActions(SetSwitch("Passive - Nanami2", Clear))
            # (Line 242) }
            DoActions(KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 243) else if (v.P_CountMain[playerID] == 3)
        if EUDElseIf()(v.P_CountMain[playerID] == 3):
            # (Line 244) {
            # (Line 245) KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", playerID);
            # (Line 246) KillUnitAt(All, "60 + 1n Siege", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", playerID))
            # (Line 247) KillUnitAt(All, "40 + 1n Mojo", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "60 + 1n Siege", "Anywhere", playerID))
            # (Line 248) KillUnitAt(All, "60 + 1n High Templar", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "40 + 1n Mojo", "Anywhere", playerID))
            # (Line 249) SetSwitch("Passive - Nanami1", Clear);
            DoActions(KillUnitAt(All, "60 + 1n High Templar", "Anywhere", playerID))
            # (Line 250) SetSwitch("Passive - Nanami2", Clear);
            DoActions(SetSwitch("Passive - Nanami1", Clear))
            # (Line 252) trg.SkillEnd();
            DoActions(SetSwitch("Passive - Nanami2", Clear))
            trg.SkillEnd()
            # (Line 253) }
            # (Line 254) }
        EUDEndIf()
        # (Line 255) if (v.P_WaitSub1[playerID] == 0)
    EUDEndIf()
    if EUDIf()(v.P_WaitSub1[playerID] == 0):
        # (Line 256) {
        # (Line 257) if (v.P_CountMain[playerID] < 3)
        if EUDIf()(v.P_CountMain[playerID] >= 3, neg=True):
            # (Line 258) {
            # (Line 259) if (v.P_CountSub1[playerID] == 0)
            if EUDIf()(v.P_CountSub1[playerID] == 0):
                # (Line 260) {
                # (Line 261) trg.Shape_Square(playerID, 1, " Unit. Schnee", 75, 75);
                trg.Shape_Square(playerID, 1, " Unit. Schnee", 75, 75)
                # (Line 263) KillUnitAt(All, " Unit. Schnee", "Anywhere", playerID);
                # (Line 265) trg.Sub1_Wait(160);
                DoActions(KillUnitAt(All, " Unit. Schnee", "Anywhere", playerID))
                trg.Sub1_Wait(160)
                # (Line 267) v.P_CountSub1[playerID] += 1;
                _ARRW(v.P_CountSub1, playerID).__iadd__(1)
                # (Line 268) }
                # (Line 269) else if (v.P_CountSub1[playerID] == 1)
            if EUDElseIf()(v.P_CountSub1[playerID] == 1):
                # (Line 270) {
                # (Line 271) trg.Shape_Square(playerID, 1, "60 + 1n Archon", 150, 0);
                trg.Shape_Square(playerID, 1, "60 + 1n Archon", 150, 0)
                # (Line 273) KillUnitAt(All, "60 + 1n Archon", "Anywhere", playerID);
                # (Line 275) trg.Sub1_Wait(160);
                DoActions(KillUnitAt(All, "60 + 1n Archon", "Anywhere", playerID))
                trg.Sub1_Wait(160)
                # (Line 277) v.P_CountSub1[playerID] += 1;
                _ARRW(v.P_CountSub1, playerID).__iadd__(1)
                # (Line 278) }
                # (Line 279) else if (v.P_CountSub1[playerID] == 2)
            if EUDElseIf()(v.P_CountSub1[playerID] == 2):
                # (Line 280) {
                # (Line 281) trg.Shape_Square(playerID, 1, "Protoss Dark Archon", 150, 75);
                trg.Shape_Square(playerID, 1, "Protoss Dark Archon", 150, 75)
                # (Line 283) KillUnitAt(All, "Protoss Dark Archon", "Anywhere", playerID);
                ...
                _ARRW(v.P_CountSub1, playerID).__iadd__(1)
                # (Line 288) }
                # (Line 289) else if (v.P_CountSub1[playerID] == 3)
            if EUDElseIf()(v.P_CountSub1[playerID] == 3):
                # (Line 290) {
                # (Line 291) trg.Shape_Square(playerID, 1, "60 + 1n Archon", 150, 150);
                ...
                _ARRW(v.P_CountSub1, playerID).__iadd__(1)
                # (Line 298) }
                # (Line 299) else if (v.P_CountSub1[playerID] == 4)
            if EUDElseIf()(v.P_CountSub1[playerID] == 4):
                # (Line 300) {
                # (Line 301) trg.Shape_Square(playerID, 1, "Protoss Dark Archon", 75, 150);
                ...
                DoActions(KillUnitAt(All, "Protoss Dark Archon", "Anywhere", playerID))
                trg.Sub1_Wait(160)
                # (Line 307) v.P_CountSub1[playerID] = 0;
            ...
            # (Line 310) }
        EUDEndIf()
        # (Line 311) if (v.P_WaitSub2[playerID] == 0)
    EUDEndIf()
    if EUDIf()(v.P_WaitSub2[playerID] == 0):
        # (Line 312) {
        # (Line 313) if (v.P_CountMain[playerID] < 2 && v.P_CountMain[playerID] > 0)
        if EUDIf()(EUDSCAnd()(v.P_CountMain[playerID] >= 2, neg=True)(v.P_CountMain[playerID] <= 0, neg=True)()):
            # (Line 314) {
            # (Line 315) if (v.P_CountSub2[playerID] == 8) v.P_CountSub2[playerID] = 0;
            if EUDIf()(v.P_CountSub2[playerID] == 8):
                _ARRW(v.P_CountSub2, playerID) << (0)
                # (Line 316) if (v.P_CountSub2[playerID] < 4)
            EUDEndIf()
            if EUDIf()(v.P_CountSub2[playerID] >= 4, neg=True):
                # (Line 317) {
                # (Line 318) trg.Shape_Dot(playerID, 1, " Unit. Schnee", 160 - 40 * v.P_CountSub2[playerID], 40 * v.P_CountSub2[playerID]);
                trg.Shape_Dot(playerID, 1, " Unit. Schnee", 160 - 40 * v.P_CountSub2[playerID], 40 * v.P_CountSub2[playerID])
                # (Line 319) trg.Shape_Dot(playerID, 1, " Unit. Schnee", -160 + 40 * v.P_CountSub2[playerID], -40 * v.P_CountSub2[playerID]);
                trg.Shape_Dot(playerID, 1, " Unit. Schnee", -160 + 40 * v.P_CountSub2[playerID], -40 * v.P_CountSub2[playerID])
                # (Line 320) trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", -40 * v.P_CountSub2[playerID], 160 - 40 * v.P_CountSub2[playerID]);
                trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", -40 * v.P_CountSub2[playerID], 160 - 40 * v.P_CountSub2[playerID])
                # (Line 321) trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", 40 * v.P_CountSub2[playerID], -160 + 40 * v.P_CountSub2[playerID]);
                trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", 40 * v.P_CountSub2[playerID], -160 + 40 * v.P_CountSub2[playerID])
                # (Line 323) KillUnitAt(All, " Unit. Schnee", "Anywhere", playerID);
                # (Line 324) KillUnitAt(All, "40 + 1n Zealot", "Anywhere", playerID);
                DoActions(KillUnitAt(All, " Unit. Schnee", "Anywhere", playerID))
                # (Line 326) trg.Sub2_Wait(320);
                DoActions(KillUnitAt(All, "40 + 1n Zealot", "Anywhere", playerID))
                trg.Sub2_Wait(320)
                # (Line 328) v.P_CountSub2[playerID] += 1;
                _ARRW(v.P_CountSub2, playerID).__iadd__(1)
                # (Line 329) }
                # (Line 330) else if (v.P_CountSub2[playerID] < 8)
            if EUDElseIf()(v.P_CountSub2[playerID] >= 8, neg=True):
                # (Line 331) {
                # (Line 332) trg.Shape_Dot(playerID, 1, " Unit. Schnee", -40 * (v.P_CountSub2[playerID] - 4), 160 - 40 * (v.P_CountSub2[playerID] - 4));
                trg.Shape_Dot(playerID, 1, " Unit. Schnee", -40 * (v.P_CountSub2[playerID] - 4), 160 - 40 * (v.P_CountSub2[playerID] - 4))
                # (Line 333) trg.Shape_Dot(playerID, 1, " Unit. Schnee", 40 * (v.P_CountSub2[playerID] - 4), -160 + 40 * (v.P_CountSub2[playerID] - 4));
                trg.Shape_Dot(playerID, 1, " Unit. Schnee", 40 * (v.P_CountSub2[playerID] - 4), -160 + 40 * (v.P_CountSub2[playerID] - 4))
                # (Line 334) trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", 160 - 40 * (v.P_CountSub2[playerID] - 4), 40 * (v.P_CountSub2[playerID] - 4));
                trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", 160 - 40 * (v.P_CountSub2[playerID] - 4), 40 * (v.P_CountSub2[playerID] - 4))
                # (Line 335) trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", -160 + 40 * (v.P_CountSub2[playerID] - 4), -40 * (v.P_CountSub2[playerID] - 4));
                trg.Shape_Dot(playerID, 1, "40 + 1n Zealot", -160 + 40 * (v.P_CountSub2[playerID] - 4), -40 * (v.P_CountSub2[playerID] - 4))
                # (Line 337) KillUnitAt(All, " Unit. Schnee", "Anywhere", playerID);
                # (Line 338) KillUnitAt(All, "40 + 1n Zealot", "Anywhere", playerID);
                DoActions(KillUnitAt(All, " Unit. Schnee", "Anywhere", playerID))
                # (Line 340) trg.Sub2_Wait(320);
                DoActions(KillUnitAt(All, "40 + 1n Zealot", "Anywhere", playerID))
                trg.Sub2_Wait(320)
                # (Line 342) v.P_CountSub2[playerID] += 1;
                _ARRW(v.P_CountSub2, playerID).__iadd__(1)
                # (Line 343) }
                # (Line 344) }
            EUDEndIf()
            # (Line 345) else if (v.P_CountMain[playerID] < 3 && v.P_CountMain[playerID] > 1)
        if EUDElseIf()(EUDSCAnd()(v.P_CountMain[playerID] >= 3, neg=True)(v.P_CountMain[playerID] <= 1, neg=True)()):
            # (Line 346) {
            # (Line 347) if (v.P_CountSub2[playerID] == 2) v.P_CountSub2[playerID] = 0;
            if EUDIf()(v.P_CountSub2[playerID] == 2):
                _ARRW(v.P_CountSub2, playerID) << (0)
                # (Line 348) if (v.P_CountSub2[playerID] < 2)
            EUDEndIf()
            if EUDIf()(v.P_CountSub2[playerID] >= 2, neg=True):
                # (Line 349) {
                # (Line 350) trg.Table_Sin(playerID, 22 + 45 * v.P_CountSub2[playerID], 100 + 50 * v.P_CountSub2[playerID]);
                trg.Table_Sin(playerID, 22 + 45 * v.P_CountSub2[playerID], 100 + 50 * v.P_CountSub2[playerID])
                # (Line 351) trg.Table_Cos(playerID, 22 + 45 * v.P_CountSub2[playerID], 100 + 50 * v.P_CountSub2[playerID]);
                trg.Table_Cos(playerID, 22 + 45 * v.P_CountSub2[playerID], 100 + 50 * v.P_CountSub2[playerID])
                # (Line 353) adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, v.P_AngleCos[playerID], v.P_AngleSin[playerID]);
                adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, v.P_AngleCos[playerID], v.P_AngleSin[playerID])
                # (Line 354) adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, -v.P_AngleCos[playerID], -v.P_AngleSin[playerID]);
                adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, -v.P_AngleCos[playerID], -v.P_AngleSin[playerID])
                # (Line 355) adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, -v.P_AngleSin[playerID], v.P_AngleCos[playerID]);
                adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, -v.P_AngleSin[playerID], v.P_AngleCos[playerID])
                # (Line 356) adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, v.P_AngleSin[playerID], -v.P_AngleCos[playerID]);
                adv.Shape_NxNSquareAt2(playerID, 1, " Unit. Schnee", 3, 32, v.P_AngleSin[playerID], -v.P_AngleCos[playerID])
                # (Line 358) KillUnitAt(All, " Unit. Schnee", "Anywhere", playerID);
