...
def f_main(playerID):
    ...
    # (Line 30) v.P_Ultimate1[playerID] = 700;
    _ARRW(v.P_Ultimate1, playerID) << (700)
    # (Line 31) v.P_Ultimate2[playerID] = 500;
...
def SkillList(playerID):
    ...
    if EUDIf()(Memory(0x00596A44, Exactly, 256)):
        ...
        # (Line 91) v.stb.printAt(7, "　　　\x04\x1FCCC + AA + AA \x04응원 \x19[ 공성 / CCC + AA - 자리고정 / 15 x 15 아군 공 방 증가 +5 ] \x1F[1]");
