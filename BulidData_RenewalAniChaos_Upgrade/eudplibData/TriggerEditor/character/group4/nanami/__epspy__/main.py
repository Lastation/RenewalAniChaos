...
def f_main(playerID):
    ...
    # (Line 31) v.P_Ultimate1[playerID] = 550;
...
def SkillList(playerID):
    ...
    if EUDIf()(Memory(0x00596A44, Exactly, 256)):
        ...
        # (Line 88) v.stb.printAt(3, "　　　\x17Passive \x04초고교급 게이머 \x19[ 아군 초당 마나 회복 증가 +5 ]");
        v.stb.printAt(3, "　　　\x17Passive \x04초고교급 게이머 \x19[ 아군 초당 마나 회복 증가 +5 ]")
        # (Line 89) v.stb.printAt(4, "　　　\x18O \x04모두의 힘 \x19[ 1분 간 아군 공 방 증가 +5 ] \x052분 30초");
        v.stb.printAt(4, "　　　\x18O \x04모두의 힘 \x19[ 1분 간 아군 공 방 증가 +5 ] \x052분 30초")
        # (Line 90) v.stb.printAt(5, "　　　\x04\x1FSSS \x04발상 \x19[ 만능 ]");
        v.stb.printAt(5, "　　　\x04\x1FSSS \x04발상 \x19[ 만능 ]")
        # (Line 91) v.stb.printAt(6, "　　　\x04\x1FACC+ CC \x04필살기 \x19[ 만능 / 자리고정 / 15 x 15 아군 공 방 증가 +5 ]");
        v.stb.printAt(6, "　　　\x04\x1FACC+ CC \x04필살기 \x19[ 만능 / 자리고정 / 15 x 15 아군 공 방 증가 +5 ]")
        # (Line 92) v.stb.printAt(7, "　　　\x04\x1FCCC + CCC + CCC \x04응원 \x19[ 공성 / CCC + CCC - 자리고정 / 15 x 15 아군 공 방 증가 +5 ] \x1F[1]");
        v.stb.printAt(7, "　　　\x04\x1FCCC + CCC + CCC \x04응원 \x19[ 공성 / CCC + CCC - 자리고정 / 15 x 15 아군 공 방 증가 +5 ] \x1F[1]")
        ...
        # (Line 95) v.stb.printAt(10, "　　　\x08AAA \x04격려 \x19[ 서포트 / 자신 제외 아군 궁게이지 +250 ] \x05", v.P_Ultimate2[playerID]);
        v.stb.printAt(10, "　　　\x08AAA \x04격려 \x19[ 서포트 / 자신 제외 아군 궁게이지 +250 ] \x05", v.P_Ultimate2[playerID])
