...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if _t9(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)()):
            ...
            # (Line 63) else if (Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill")
        _t10 = EUDElseIf()
        # (Line 64) && Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill") && v.P_Step[playerID] == 210)
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 210)()):
            ...
            # (Line 73) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 74) else if (Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill") && v.P_Step[playerID] == 200)
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            ...
            # (Line 82) }
            DoActions(KillUnitAt(2, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 83) else if (Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill")
        _t12 = EUDElseIf()
        ...
        if _t12(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 230)()):
            ...
            # (Line 91) KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 92) }
            DoActions(KillUnitAt(3, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 93) else if (Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill")
        _t13 = EUDElseIf()
        ...
        if _t13(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 240)()):
            ...
            # (Line 101) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID);
            # (Line 102) }
            DoActions(KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 104) else if (Bring(playerID, AtLeast, 1, "Protoss Corsair", "[Skill]UseSkill")
        _t14 = EUDElseIf()
        # (Line 105) && v.P_Step[playerID] == 250
        # (Line 106) && v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])
        if _t14(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Corsair", "[Skill]UseSkill"))(v.P_Step[playerID] == 250)(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                # (Line 113) v.P_SkillDelay[playerID] = 0;
                DoActions(CreateUnit(1, " Item. Flag", "[Uiltimate]Flag", CurrentPlayer))
                _ARRW(v.P_SkillDelay, playerID) << (0)
                # (Line 114) v.P_CountMain[playerID] = 0;
                _ARRW(v.P_CountMain, playerID) << (0)
                # (Line 115) v.P_LoopMain[playerID] = 0;
                _ARRW(v.P_LoopMain, playerID) << (0)
                # (Line 116) v.P_Step[playerID] = 260;
                _ARRW(v.P_Step, playerID) << (260)
                # (Line 117) SetDeaths(playerID, Subtract, v.P_Ultimate1[playerID], " `UltimateCoolTime");
                ...
                # (Line 121) {
            if EUDElse()():
                # (Line 122) SetResources(CurrentPlayer, Add, 60, Gas);
                ...
                # (Line 126) }
            EUDEndIf()
            # (Line 127) else if (Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill")
        _t16 = EUDElseIf()
        ...
        if _t16(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])()):
            ...
            # (Line 137) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID);
