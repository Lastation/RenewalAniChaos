...
def SkillList(playerID):
    ...
    if EUDIf()(Memory(0x00596A44, Exactly, 256)):
        ...
        # (Line 89) v.stb.printAt(5, "　　　\x04\x1FCCC + AC + CC \x04비익연리의 달링 \x19[ 대인 / 지속딜 / CCC + AC - 자리고정 / 쉴드고정 1 ]");
        v.stb.printAt(5, "　　　\x04\x1FCCC + AC + CC \x04비익연리의 달링 \x19[ 대인 / 지속딜 / CCC + AC - 자리고정 / 쉴드고정 1 ]")
