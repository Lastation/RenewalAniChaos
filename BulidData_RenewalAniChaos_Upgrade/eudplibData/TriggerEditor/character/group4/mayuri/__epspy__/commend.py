...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            ...
            # (Line 74) else if (Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill")
        _t11 = EUDElseIf()
        # (Line 75) && v.P_Step[playerID] == 220)
        ...
        if _t12(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])()):
            ...
            # (Line 93) SetDeaths(playerID, Subtract, v.P_Ultimate1[playerID], " `UltimateCoolTime");
            # (Line 94) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID);
