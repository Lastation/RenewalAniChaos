...
def Text2(num):
    ...
    if _t1(13000):
        ...
        # (Line 80) case 13001:
    _t2 = EUDSwitchCase()
    # (Line 81) PlayWAV("sakura_05.ogg");
    if _t2(13001):
        # (Line 82) v.stb.printAt(3,"\x13\x1BMato Sakura\n\x13\x08이런 사람... 없었으면 좋았을텐데...");
