...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 210)()):
            ...
            # (Line 64) }
            DoActions(SetSwitch("Recall - Rusalka", Set))
            # (Line 65) else if (Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill") && Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill") &&  v.P_Step[playerID] == 300)
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)()):
            # (Line 66) {
            ...
            # (Line 71) KillUnitAt(1, "Protoss Scout", "[Skill]UseSkill", playerID);
            DoActions(KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID))
            # (Line 72) }
            DoActions(KillUnitAt(1, "Protoss Scout", "[Skill]UseSkill", playerID))
            # (Line 75) else if (Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill")
        _t12 = EUDElseIf()
        # (Line 76) && Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill")
        ...
        if _t12(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])(v.P_Step[playerID] == 300)()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                # (Line 88) KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID);
                # (Line 89) KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID);
                DoActions(KillUnitAt(2, "Protoss Arbiter", "[Skill]UseSkill", playerID))
                # (Line 90) }
                DoActions(KillUnitAt(1, "Protoss Carrier", "[Skill]UseSkill", playerID))
                # (Line 91) else
                # (Line 92) {
            if EUDElse()():
                # (Line 93) SetResources(CurrentPlayer, Add, 800, Gas);
