...
def f_main(playerID):
    ...
    # (Line 8) MoveUnit(All, "40 + 1n Mojo", playerID, "Anywhere", "[Skill]HoldPosition");
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        # (Line 14) {
        # (Line 15) if (v.P_CountMain[playerID] == 0 && v.P_LoopMain[playerID] <= 6)
        if EUDIf()(EUDSCAnd()(v.P_CountMain[playerID] == 0)(v.P_LoopMain[playerID] <= 6)()):
            # (Line 16) {
            # (Line 17) trg.Shape_Square(playerID, 1, "80 + 1n Tank", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1));
            trg.Shape_Square(playerID, 1, "80 + 1n Tank", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1))
            # (Line 18) trg.Shape_Square(playerID, 1, "Zerg Devourer", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1));
            trg.Shape_Square(playerID, 1, "Zerg Devourer", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1))
            # (Line 19) KillUnitAt(All, "80 + 1n Tank", "Anywhere", playerID);
            # (Line 20) KillUnitAt(All, "Zerg Devourer", "Anywhere", playerID);
            ...
            # (Line 23) }
            # (Line 24) else if (v.P_CountMain[playerID] == 0 && v.P_LoopMain[playerID] == 7)
        if EUDElseIf()(EUDSCAnd()(v.P_CountMain[playerID] == 0)(v.P_LoopMain[playerID] == 7)()):
            # (Line 25) {
            # (Line 26) trg.Shape_Square(playerID, 1, "50 + 1n Tank", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1));
            trg.Shape_Square(playerID, 1, "50 + 1n Tank", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1))
            # (Line 27) trg.Shape_Square(playerID, 1, "Zerg Devourer", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1));
            trg.Shape_Square(playerID, 1, "Zerg Devourer", 16 * (v.P_LoopMain[playerID] + 1), 16 * (v.P_LoopMain[playerID] + 1))
            # (Line 28) KillUnitAt(All, "Zerg Devourer", "Anywhere", playerID);
            ...
            # (Line 32) }
            # (Line 33) else if (v.P_CountMain[playerID] == 1 && v.P_LoopMain[playerID] <= 7)
        if EUDElseIf()(EUDSCAnd()(v.P_CountMain[playerID] == 1)(v.P_LoopMain[playerID] <= 7)()):
            # (Line 34) {
            # (Line 35) trg.Shape_Square(playerID, 1, "80 + 1n Tank", 20 * (v.P_LoopMain[playerID] + 1), 0);
            trg.Shape_Square(playerID, 1, "80 + 1n Tank", 20 * (v.P_LoopMain[playerID] + 1), 0)
            # (Line 36) trg.Shape_Square(playerID, 1, "Zerg Devourer", 20 * (v.P_LoopMain[playerID] + 1), 0);
            trg.Shape_Square(playerID, 1, "Zerg Devourer", 20 * (v.P_LoopMain[playerID] + 1), 0)
            # (Line 37) KillUnitAt(All, "80 + 1n Tank", "Anywhere", playerID);
            # (Line 38) KillUnitAt(All, "Zerg Devourer", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "80 + 1n Tank", "Anywhere", playerID))
            ...
            _ARRW(v.P_LoopMain, playerID).__iadd__(1)
            # (Line 41) }
            # (Line 42) else if (v.P_CountMain[playerID] == 1 && v.P_LoopMain[playerID] == 8)
        if EUDElseIf()(EUDSCAnd()(v.P_CountMain[playerID] == 1)(v.P_LoopMain[playerID] == 8)()):
            # (Line 43) {
            # (Line 44) trg.Shape_Square(playerID, 1, "50 + 1n Tank", 20 * (v.P_LoopMain[playerID] + 1), 0);
            trg.Shape_Square(playerID, 1, "50 + 1n Tank", 20 * (v.P_LoopMain[playerID] + 1), 0)
            # (Line 45) trg.Shape_Square(playerID, 1, "Zerg Devourer",  20 * (v.P_LoopMain[playerID] + 1), 0);
            trg.Shape_Square(playerID, 1, "Zerg Devourer", 20 * (v.P_LoopMain[playerID] + 1), 0)
            # (Line 46) trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0);
            trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0)
            # (Line 47) MoveUnit(All, "50 + 1n Tank", playerID, "[Skill]Unit_Wait_ALL", v.P_LocationID[playerID]);
            # (Line 48) Order("50 + 1n Tank", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 2):
            # (Line 55) {
            # (Line 56) trg.Shape_Square(playerID, 1, "40 + 1n Marine", 64, 64);
            trg.Shape_Square(playerID, 1, "40 + 1n Marine", 64, 64)
            # (Line 57) trg.Shape_Square(playerID, 1, "40 + 1n Marine", 90, 0);
            trg.Shape_Square(playerID, 1, "40 + 1n Marine", 90, 0)
            # (Line 58) trg.Shape_Square(playerID, 8, "40 + 1n Lurker",  64, 64);
            trg.Shape_Square(playerID, 8, "40 + 1n Lurker", 64, 64)
            # (Line 59) trg.Shape_Square(playerID, 8, "40 + 1n Lurker",  90, 0);
            trg.Shape_Square(playerID, 8, "40 + 1n Lurker", 90, 0)
            # (Line 60) trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0);
            trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0)
            # (Line 61) MoveUnit(All, "40 + 1n Marine", playerID, "[Skill]Unit_Wait_ALL", v.P_LocationID[playerID]);
            # (Line 62) Order("40 + 1n Marine", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
            DoActions(MoveUnit(All, "40 + 1n Marine", playerID, "[Skill]Unit_Wait_ALL", v.P_LocationID[playerID]))
            # (Line 63) KillUnitAt(All, "40 + 1n Lurker", "Anywhere", playerID);
            DoActions(Order("40 + 1n Marine", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
            # (Line 64) trg.Main_Wait(3500);
            DoActions(KillUnitAt(All, "40 + 1n Lurker", "Anywhere", playerID))
            trg.Main_Wait(3500)
            # (Line 65) v.P_CountMain[playerID] += 1;
            _ARRW(v.P_CountMain, playerID).__iadd__(1)
            # (Line 66) }
            # (Line 67) else if (v.P_CountMain[playerID] == 3 && v.P_LoopMain[playerID] <= 3)
        if EUDElseIf()(EUDSCAnd()(v.P_CountMain[playerID] == 3)(v.P_LoopMain[playerID] <= 3)()):
            # (Line 68) {
            # (Line 69) trg.Shape_Square(playerID, 8, "60 + 1n High Templar", 32 * (v.P_LoopMain[playerID] + 1), 32 * (v.P_LoopMain[playerID] + 1));
            trg.Shape_Square(playerID, 8, "60 + 1n High Templar", 32 * (v.P_LoopMain[playerID] + 1), 32 * (v.P_LoopMain[playerID] + 1))
            # (Line 70) trg.Shape_Square(playerID, 8, "60 + 1n High Templar", 45 * (v.P_LoopMain[playerID] + 1), 0);
            ...
            _ARRW(v.P_LoopMain, playerID).__iadd__(1)
            # (Line 74) }
            # (Line 75) else if (v.P_CountMain[playerID] == 3 && v.P_LoopMain[playerID] == 4)
        if EUDElseIf()(EUDSCAnd()(v.P_CountMain[playerID] == 3)(v.P_LoopMain[playerID] == 4)()):
            # (Line 76) {
            # (Line 77) trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 64, 64);
            trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 64, 64)
            # (Line 78) trg.Shape_Square(playerID, 8, "Torrasque", 90, 0);
            ...
            # (Line 82) trg.Main_Wait(0);
            DoActions(KillUnitAt(All, "Torrasque", "Anywhere", playerID))
            trg.Main_Wait(0)
            # (Line 83) v.P_LoopMain[playerID] += 1;
            _ARRW(v.P_LoopMain, playerID).__iadd__(1)
            # (Line 84) }
            # (Line 85) else if (v.P_CountMain[playerID] == 3 && v.P_LoopMain[playerID] == 5)
        if EUDElseIf()(EUDSCAnd()(v.P_CountMain[playerID] == 3)(v.P_LoopMain[playerID] == 5)()):
            # (Line 86) {
            # (Line 87) s.CharacterVoice(2);
            s.CharacterVoice(2)
            # (Line 88) trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 180, 0);
            trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 180, 0)
            # (Line 89) trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 128, 128);
            trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 128, 128)
            # (Line 90) trg.Shape_Square(playerID, 8, "Torrasque", 128, 128);
            trg.Shape_Square(playerID, 8, "Torrasque", 128, 128)
            # (Line 91) trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0);
            trg.MoveLoc(v.P_UnitID[playerID], playerID, 0, 0)
            # (Line 92) Order("60 + 1n Danimoth", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
            # (Line 93) KillUnitAt(All, "Torrasque", "Anywhere", playerID);
            DoActions(Order("60 + 1n Danimoth", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
            # (Line 94) trg.Main_Wait(2750);
            DoActions(KillUnitAt(All, "Torrasque", "Anywhere", playerID))
            trg.Main_Wait(2750)
            ...
            _ARRW(v.P_LoopMain, playerID) << (0)
            # (Line 97) }
            # (Line 98) else if (v.P_CountMain[playerID] == 4
        _t10 = EUDElseIf()
        # (Line 99) && Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))
        if _t10(EUDSCAnd()(v.P_CountMain[playerID] == 4)(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))()):
            # (Line 100) {
            # (Line 101) KillUnitAt(All, "40 + 1n Marine", "Anywhere", playerID);
            ...
            # (Line 106) s.CharacterVoice(3);
            DoActions(KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", playerID))
            s.CharacterVoice(3)
            # (Line 107) KillUnitAt(2, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 109) v.P_Step[playerID] = 220;
            ...
            _ARRW(v.P_LoopMain, playerID) << (0)
            # (Line 112) }
            # (Line 113) else if (v.P_CountMain[playerID] == 4)
        if EUDElseIf()(v.P_CountMain[playerID] == 4):
            # (Line 114) {
            # (Line 115) KillUnitAt(All, "40 + 1n Marine", "Anywhere", playerID);
            # (Line 116) KillUnitAt(All, "40 + 1n Mojo", "Anywhere", playerID);
            DoActions(KillUnitAt(All, "40 + 1n Marine", "Anywhere", playerID))
