...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        ...
        if EUDIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Scout", "[Skill]UseSkill"))(v.P_Step[playerID] == 100)()):
            ...
            # (Line 58) else if (Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill")
        _t10 = EUDElseIf()
        # (Line 59) && Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill") &&  v.P_Step[playerID] == 200)
        if _t10(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Carrier", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            ...
            # (Line 66) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 69) else if (Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill")
        _t11 = EUDElseIf()
        # (Line 70) && v.P_Step[playerID] == 300
        # (Line 71) && v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])()):
            # (Line 72) {
            # (Line 73) if (Switch("UiltimateSwitch", Cleared))
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                # (Line 74) {
                # (Line 75) s.CharacterVoice(11);
                s.CharacterVoice(11)
                # (Line 76) SetSwitch("UiltimateSwitch", Set);
                # (Line 77) v.P_SkillDelay[playerID] = 0;
                DoActions(SetSwitch("UiltimateSwitch", Set))
                _ARRW(v.P_SkillDelay, playerID) << (0)
                # (Line 78) v.P_Step[playerID] = 240;
                ...
                # (Line 82) SetSwitch("Recall - Chtholly", Set);
