...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            # (Line 10) {
            # (Line 11) KillUnitAt(All, "40 + 1n Mojo", "Anywhere", CurrentPlayer);
            # (Line 12) RemoveUnitAt(All, "80 + 1n Vulture", "Anywhere", CurrentPlayer);
            DoActions(KillUnitAt(All, "40 + 1n Mojo", "Anywhere", CurrentPlayer))
            # (Line 13) RemoveUnitAt(All, "60 + 3n Ghost", "Anywhere", CurrentPlayer);
            DoActions(RemoveUnitAt(All, "80 + 1n Vulture", "Anywhere", CurrentPlayer))
            # (Line 14) KillUnitAt(All, "100 + 1n Hyperion", "Anywhere", CurrentPlayer);
            DoActions(RemoveUnitAt(All, "60 + 3n Ghost", "Anywhere", CurrentPlayer))
            # (Line 16) if (v.P_LoopMain[playerID] < 17)
            DoActions(KillUnitAt(All, "100 + 1n Hyperion", "Anywhere", CurrentPlayer))
            if EUDIf()(v.P_LoopMain[playerID] >= 17, neg=True):
                # (Line 17) {
                # (Line 18) var Degree = (15 * v.P_LoopMain[playerID]) % 90;
                Degree = EUDVariable()
                Degree << ((15 * v.P_LoopMain[playerID]) % 90)
                # (Line 19) trg.Table_Cos(playerID, Degree, 224);
                trg.Table_Cos(playerID, Degree, 224)
                # (Line 20) trg.Table_Sin(playerID, Degree, 224);
                trg.Table_Sin(playerID, Degree, 224)
                # (Line 22) trg.Shape_Square(playerID, 1, "40 + 1n Ghost", v.P_AngleCos[playerID], v.P_AngleSin[playerID]);
                trg.Shape_Square(playerID, 1, "40 + 1n Ghost", v.P_AngleCos[playerID], v.P_AngleSin[playerID])
                # (Line 23) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32)
                # (Line 24) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32)
                # (Line 25) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32)
                # (Line 26) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32)
                # (Line 27) RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID);
                # (Line 28) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32);
                DoActions(RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID))
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32)
                # (Line 29) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32)
                # (Line 30) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32)
                # (Line 31) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32)
                # (Line 32) RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID);
                # (Line 33) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32);
                DoActions(RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID))
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32)
                # (Line 34) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32)
                # (Line 35) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32)
                # (Line 36) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32)
                # (Line 37) RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID);
                # (Line 38) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32);
                DoActions(RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID))
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 32, 32)
                # (Line 39) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "40 + 1n Mojo", 0, 32)
                # (Line 40) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 32, 32)
                # (Line 41) adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32);
                adv.Shape_SquareAt(playerID, "40 + 1n Ghost", 1, "80 + 1n Vulture", 0, 32)
                # (Line 42) RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID);
                # (Line 43) trg.Shape_Square(playerID, 1, "40 + 1n Gantrithor", v.P_AngleCos[playerID], v.P_AngleSin[playerID]);
                DoActions(RemoveUnitAt(1, "40 + 1n Ghost", "Anywhere", playerID))
                trg.Shape_Square(playerID, 1, "40 + 1n Gantrithor", v.P_AngleCos[playerID], v.P_AngleSin[playerID])
                # (Line 44) trg.Shape_Square(playerID, 1, "60 + 3n Ghost", v.P_AngleCos[playerID], v.P_AngleSin[playerID]);
                trg.Shape_Square(playerID, 1, "60 + 3n Ghost", v.P_AngleCos[playerID], v.P_AngleSin[playerID])
                # (Line 45) trg.Shape_Square(playerID, 1, "100 + 1n Hyperion", 32, 32);
                trg.Shape_Square(playerID, 1, "100 + 1n Hyperion", 32, 32)
                # (Line 46) trg.Shape_Square(playerID, 1, "100 + 1n Hyperion", 0, 32);
                trg.Shape_Square(playerID, 1, "100 + 1n Hyperion", 0, 32)
                # (Line 47) trg.Shape_Square(playerID, 1, "Bengalaas", 32, 32);
                trg.Shape_Square(playerID, 1, "Bengalaas", 32, 32)
                # (Line 48) trg.Shape_Square(playerID, 1, "Bengalaas", 0, 32);
