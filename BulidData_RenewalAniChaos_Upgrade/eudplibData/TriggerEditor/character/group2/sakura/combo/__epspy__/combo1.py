    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            ...
            if EUDIf()(v.P_LoopMain[playerID] >= 4, neg=True):
                # (Line 15) {
                # (Line 16) var d = 100 - 5 * v.P_LoopMain[playerID];
                d = EUDVariable()
                d << (100 - 5 * v.P_LoopMain[playerID])
                # (Line 17) trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 0, d);
                trg.Shape_Square(playerID, 1, "40 + 1n Mutalisk", 0, d)
                # (Line 18) trg.Shape_Square(playerID, 1, "Protoss Dark Archon", 0, d);
                ...
                # (Line 21) Order("40 + 1n Mutalisk", playerID, "Anywhere", Attack, v.P_LocationID[playerID]);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 4):
                # (Line 26) {
                # (Line 27) adv.Shape_QuadNxNSquareAt(playerID, 1, " Unit. Hoffnung 25000", 3, 50, 100, 100);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 5):
                # (Line 31) {
                # (Line 32) adv.Shape_QuadNxNSquareAt(playerID, 1, "40 + 1n Guardian", 2, 50, 100, 100);
                ...
                # (Line 37) else if (v.P_LoopMain[playerID] == 10)
            if EUDElseIf()(v.P_LoopMain[playerID] == 10):
                # (Line 38) {
                # (Line 39) KillUnitAt(All, "40 + 1n Guardian", "Anywhere", playerID);
                # (Line 40) }
                DoActions(KillUnitAt(All, "40 + 1n Guardian", "Anywhere", playerID))
                # (Line 41) else if (v.P_LoopMain[playerID] == 11)
            if EUDElseIf()(v.P_LoopMain[playerID] == 11):
                # (Line 42) {
                # (Line 43) adv.Shape_QuadNxNSquareAt(playerID, 1, "50 + 1n Battlecruiser", 2, 50, 100, 100);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 13):
                # (Line 49) {
                # (Line 50) RemoveUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID);
                # (Line 52) adv.Shape_QuadNxNSquareAt(playerID, 1, "Kakaru (Twilight)", 3, 50, 100, 100);
            ...
            # (Line 60) if (v.P_LoopMain[playerID] == 14)
