...
def f_main(playerID):
    ...
    if EUDIf()(EUDSCAnd()(v.P_SkillDelay[playerID] >= 2)(v.P_CountMain[playerID] == 0)()):
        # (Line 45) {
        # (Line 46) if (Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill") &&
        _t8 = EUDIf()
        # (Line 47) Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill") && v.P_Step[playerID] == 100)
        if _t8(EUDSCAnd()(Bring(playerID, AtLeast, 1, "Protoss Scout", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 100)()):
            ...
            # (Line 54) KillUnitAt(1, "Protoss Scout", "[Skill]UseSkill", playerID);
            # (Line 55) KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID);
            DoActions(KillUnitAt(1, "Protoss Scout", "[Skill]UseSkill", playerID))
            # (Line 56) }
            DoActions(KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID))
            # (Line 57) else if (Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill") && v.P_Step[playerID] == 200)
        if EUDElseIf()(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(v.P_Step[playerID] == 200)()):
            ...
            _ARRW(v.P_LoopMain, playerID) << (0)
            # (Line 63) v.P_Step[playerID] = 210;
            _ARRW(v.P_Step, playerID) << (210)
            # (Line 64) KillUnitAt(2, "Protoss Carrier", "[Skill]UseSkill", playerID);
            # (Line 65) }
        ...
        # (Line 80) && v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])
        if _t11(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 220)(v.P_UltimateGauge[playerID] >= v.P_Ultimate2[playerID])()):
            # (Line 81) {
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                ...
                # (Line 91) SetDeaths(playerID, Subtract, v.P_Ultimate2[playerID], " `UltimateCoolTime");
                ...
                # (Line 95) {
            if EUDElse()():
                # (Line 96) SetResources(CurrentPlayer, Add, 600, Gas);
                ...
                # (Line 100) }
            EUDEndIf()
            # (Line 102) else if (Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill")
        _t13 = EUDElseIf()
        # (Line 103) && v.P_Step[playerID] == 300
        ...
        if _t13(EUDSCAnd()(Bring(playerID, AtLeast, 3, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 300)(v.P_UltimateGauge[playerID] >= v.P_Ultimate1[playerID])()):
            ...
            if EUDIf()(Switch("UiltimateSwitch", Cleared)):
                # (Line 107) {
                # (Line 108) s.CharacterVoice(7);
                s.CharacterVoice(7)
                # (Line 109) SetSwitch("UiltimateSwitch", Set);
                # (Line 110) CreateUnit(1, " Item. Flag", "[Uiltimate]Flag", CurrentPlayer);
                DoActions(SetSwitch("UiltimateSwitch", Set))
                # (Line 111) v.P_SkillDelay[playerID] = 0;
                DoActions(CreateUnit(1, " Item. Flag", "[Uiltimate]Flag", CurrentPlayer))
                _ARRW(v.P_SkillDelay, playerID) << (0)
                # (Line 112) v.P_CountMain[playerID] = 0;
                _ARRW(v.P_CountMain, playerID) << (0)
                # (Line 113) v.P_LoopMain[playerID] = 0;
                _ARRW(v.P_LoopMain, playerID) << (0)
                # (Line 114) v.P_Step[playerID] = 320;
                _ARRW(v.P_Step, playerID) << (320)
                # (Line 115) SetDeaths(playerID, Subtract, v.P_Ultimate1[playerID], " `UltimateCoolTime");
