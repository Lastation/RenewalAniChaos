...
# (Line 1) import func.trig as trg;
from func import trig as trg
# (Line 2) import variable as v;
import variable as v
# (Line 3) import system.text as text;
from system import text as text
# (Line 5) import character.group1.rusaruka.main 	as rusaruka;
from character.group1.rusaruka import main as rusaruka
# (Line 6) import character.group1.chtholly.main 	as chtholly;
...
# (Line 9) import character.group3.kurumi.main 	as kurumi;
...
# (Line 23) import character.group6.hodaka.main 	as hodaka;
from character.group6.hodaka import main as hodaka
# (Line 24) import character.group6.tsukasa.main 	as tsukasa;
from character.group6.tsukasa import main as tsukasa
# (Line 26) function main(playerID)
# (Line 27) {
@EUDFunc
def f_main(playerID):
    # (Line 28) trg.Main_WaitLoop();
    trg.Main_WaitLoop()
    # (Line 30) text.BuildingText(playerID);
    text.BuildingText(playerID)
    # (Line 31) text.ShopText(playerID);
    ...
    if EUDElseIf()(v.P_HeroID[playerID] == 3):
        ...
        # (Line 37) else if 	(v.P_HeroID[playerID] == 12) 	kurumi.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 12):
        kurumi.f_main(playerID)
        # (Line 39) else if 	(v.P_HeroID[playerID] == 22) 	yuuna.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 22):
        yuuna.f_main(playerID)
        # (Line 40) else if 	(v.P_HeroID[playerID] == 23) 	mayuri.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 23):
        mayuri.f_main(playerID)
        # (Line 41) else if 	(v.P_HeroID[playerID] == 24) 	nanami.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 24):
        nanami.f_main(playerID)
        # (Line 42) else if 	(v.P_HeroID[playerID] == 25) 	milim.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 25):
        milim.f_main(playerID)
        # (Line 44) else if 	(v.P_HeroID[playerID] == 26) 	yume.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 26):
        yume.f_main(playerID)
        # (Line 45) else if 	(v.P_HeroID[playerID] == 27) 	magane.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 27):
        magane.f_main(playerID)
        # (Line 46) else if 	(v.P_HeroID[playerID] == 28) 	oda.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 28):
        oda.f_main(playerID)
        # (Line 47) else if 	(v.P_HeroID[playerID] == 29) 	ekidona.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 29):
        ekidona.f_main(playerID)
        # (Line 48) else if 	(v.P_HeroID[playerID] == 30) 	niwa.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 30):
        niwa.f_main(playerID)
        # (Line 50) else if 	(v.P_HeroID[playerID] == 31) 	park.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 31):
        park.f_main(playerID)
        # (Line 51) else if 	(v.P_HeroID[playerID] == 32) 	hodaka.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 32):
        hodaka.f_main(playerID)
        # (Line 52) else if 	(v.P_HeroID[playerID] == 34) 	tsukasa.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 34):
        tsukasa.f_main(playerID)
        # (Line 54) SetDeaths(playerID, SetTo, v.P_Shield[playerID], " `SystemShield");
    EUDEndIf()
    # (Line 55) }
