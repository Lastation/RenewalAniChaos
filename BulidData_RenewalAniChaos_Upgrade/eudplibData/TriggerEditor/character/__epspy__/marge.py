...
# (Line 10) import character.group4.yuuna.main 		as yuuna;
from character.group4.yuuna import main as yuuna
# (Line 11) import character.group4.mayuri.main 	as mayuri;
from character.group4.mayuri import main as mayuri
# (Line 12) import character.group4.nanami.main 	as nanami;
from character.group4.nanami import main as nanami
# (Line 13) import character.group4.milim.main 		as milim;
from character.group4.milim import main as milim
# (Line 15) import character.group5.yume.main 		as yume;
from character.group5.yume import main as yume
# (Line 16) import character.group5.magane.main 	as magane;
from character.group5.magane import main as magane
# (Line 17) import character.group5.oda.main 		as oda;
from character.group5.oda import main as oda
# (Line 18) import character.group5.ekidona.main 	as ekidona;
from character.group5.ekidona import main as ekidona
# (Line 19) import character.group5.niwa.main 		as niwa;
from character.group5.niwa import main as niwa
# (Line 21) import character.group6.park.main 		as park;
from character.group6.park import main as park
# (Line 24) function main(playerID)
# (Line 25) {
@EUDFunc
def f_main(playerID):
    # (Line 26) trg.Main_WaitLoop();
    trg.Main_WaitLoop()
    # (Line 28) text.BuildingText(playerID);
    text.BuildingText(playerID)
    # (Line 29) text.ShopText(playerID);
    text.ShopText(playerID)
    # (Line 31) v.P_UltimateGauge[playerID] = 1000;
    _ARRW(v.P_UltimateGauge, playerID) << (1000)
    # (Line 33) ModifyUnitHitPoints(1, 155, playerID, "Anywhere", 100 - (v.P_UniqueCool[playerID] / 10));
    # (Line 34) ModifyUnitShields(1, 167, playerID, "Anywhere", v.P_UltimateGauge[playerID] / 10);
    DoActions(ModifyUnitHitPoints(1, 155, playerID, "Anywhere", 100 - (v.P_UniqueCool[playerID] // 10)))
    # (Line 36) if 		(v.P_HeroID[playerID] == 1) 		rusaruka.main(playerID);
    ...
    if EUDIf()(v.P_HeroID[playerID] == 1):
        ...
        # (Line 37) else if 	(v.P_HeroID[playerID] == 2) 		chtholly.main(playerID);
    if EUDElseIf()(v.P_HeroID[playerID] == 2):
        chtholly.f_main(playerID)
        # (Line 38) else if 	(v.P_HeroID[playerID] == 3) 		maihime.main(playerID);
    ...
    if EUDElseIf()(v.P_HeroID[playerID] == 31):
        ...
        # (Line 54) if(playerID < 6 && bread(0x58D2B0 + 0x207C * (0 / 46) + playerID * (46 - 31 * (0 / 46)) + (0 % 46)) != 80)
    EUDEndIf()
    if EUDIf()(EUDSCAnd()(playerID >= 6, neg=True)(f_bread(0x58D2B0 + 0x207C * (0 // 46) + playerID * (46 - 31 * (0 // 46)) + (0 % 46)) == 80, neg=True)()):
        # (Line 55) {
        # (Line 56) bwrite(0x58D2B0 + 0x207C * (0 / 46) + playerID * (46 - 31 * (0 / 46)) + (0 % 46), 60);
        f_bwrite(0x58D2B0 + 0x207C * (0 // 46) + playerID * (46 - 31 * (0 // 46)) + (0 % 46), 60)
        # (Line 57) bwrite(0x58D2B0 + 0x207C * (7 / 46) + playerID * (46 - 31 * (7 / 46)) + (7 % 46), 80);
        f_bwrite(0x58D2B0 + 0x207C * (7 // 46) + playerID * (46 - 31 * (7 // 46)) + (7 % 46), 80)
        # (Line 59) bwrite(0x58D2B0 + 0x207C * (2 / 46) + playerID * (46 - 31 * (2 / 46)) + (2 % 46), 60); 	//방어력 최종 적용
        f_bwrite(0x58D2B0 + 0x207C * (2 // 46) + playerID * (46 - 31 * (2 // 46)) + (2 % 46), 60)
        # (Line 60) bwrite(0x58D2B0 + 0x207C * (9 / 46) + playerID * (46 - 31 * (9 / 46)) + (9 % 46), 80);		//공격력 최종 적용
