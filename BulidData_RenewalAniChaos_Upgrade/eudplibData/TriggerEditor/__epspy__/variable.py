...
# (Line 66) const B_TargetPos_X 	= PVariable();
B_TargetPos_X = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 67) const B_TargetPos_Y 	= PVariable();
B_TargetPos_Y = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 68) const B_BulletPos_X 	= PVariable();
B_BulletPos_X = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 69) const B_BulletPos_Y 	= PVariable();
B_BulletPos_Y = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 70) const B_OriginPos_X = PVariable();
B_OriginPos_X = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 71) const B_OriginPos_Y = PVariable();
B_OriginPos_Y = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 72) const B_Delta_X		= PVariable();
B_Delta_X = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 73) const B_Delta_Y		= PVariable();
B_Delta_Y = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 74) const B_Speed		= PVariable();
B_Speed = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 75) const B_IsHit 		= PVariable();
B_IsHit = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 78) const bgmWait		= PVariable();
bgmWait = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 81) const P_KillScore		= PVariable();
P_KillScore = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 84) const P_ZenitsuDebuff = PVariable();
P_ZenitsuDebuff = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 86) const P_GozoDebuff = PVariable();
P_GozoDebuff = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 87) const P_GozoDebuff_Ally = PVariable();
P_GozoDebuff_Ally = _CGFW(lambda: [PVariable()], 1)[0]
