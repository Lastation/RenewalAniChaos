...
# (Line 28) const P_UniqueCool			= PVariable();
P_UniqueCool = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 29) const P_UniqueCondition	= PVariable();
P_UniqueCondition = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 32) const P_WaitMain	= PVariable();
P_WaitMain = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 33) const P_WaitSub1	= PVariable();
P_WaitSub1 = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 34) const P_WaitSub2	= PVariable();
P_WaitSub2 = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 37) const P_CountMain	= PVariable();
P_CountMain = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 38) const P_CountSub1	= PVariable();
P_CountSub1 = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 39) const P_CountSub2	= PVariable();
P_CountSub2 = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 42) const P_LoopMain	= PVariable();
P_LoopMain = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 43) const P_LoopSub1	= PVariable();
P_LoopSub1 = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 44) const P_LoopSub2	= PVariable();
P_LoopSub2 = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 47) const P_Step			= PVariable();
P_Step = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 48) const P_Shield			= PVariable();
P_Shield = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 49) const P_Ally				= PVariable();
P_Ally = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 50) const P_SkillDelay		= PVariable();
P_SkillDelay = _CGFW(lambda: [PVariable()], 1)[0]
# (Line 51) const P_HoldLocation 	= [97, 119, 122, 126, 134, 143, 0, 0];
