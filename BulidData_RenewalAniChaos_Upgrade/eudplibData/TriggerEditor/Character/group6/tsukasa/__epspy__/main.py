...
def SkillList(playerID):
    ...
    if EUDIf()(Memory(0x00596A44, Exactly, 256)):
        ...
        # (Line 34) v.stb.printAt(5, "　　　\x04\x1FCCCC + A\x04 추억 \x19[ 공성 / 순간딜 / 자리고정 ]");
        v.stb.printAt(5, "　　　\x04\x1FCCCC + A\x04 추억 \x19[ 공성 / 순간딜 / 자리고정 ]")
        # (Line 35) v.stb.printAt(6, "　　　\x04\x1FCAS + AACC + CCA \x04첫 경험 \x19[ 공성 / 지속딜 / 자리고정 ] \x1F[1]");
        v.stb.printAt(6, "　　　\x04\x1FCAS + AACC + CCA \x04첫 경험 \x19[ 공성 / 지속딜 / 자리고정 ] \x1F[1]")
        # (Line 36) v.stb.printAt(7, "\n");
        v.stb.printAt(7, "\n")
        # (Line 37) v.stb.printAt(8, "　　　\x1F[1]\x08 + SS \x04인생의 동반자 \x19[ 공성 / 선딜 5.5초 ] \x05", v.P_Ultimate1[playerID]);
        v.stb.printAt(8, "　　　\x1F[1]\x08 + SS \x04인생의 동반자 \x19[ 공성 / 선딜 5.5초 ] \x05", v.P_Ultimate1[playerID])
        # (Line 38) v.stb.printAt(9, "　　　\x08AAAA \x04인생의 동반자 \x19[ 공성 / 선딜 5.5초 / 쉴드고정 ] \x05", v.P_Ultimate2[playerID]);
        v.stb.printAt(9, "　　　\x08AAAA \x04인생의 동반자 \x19[ 공성 / 선딜 5.5초 / 쉴드고정 ] \x05", v.P_Ultimate2[playerID])
...
def f_main(playerID):
    ...
    # (Line 50) v.P_Ultimate1[playerID] = 650;
