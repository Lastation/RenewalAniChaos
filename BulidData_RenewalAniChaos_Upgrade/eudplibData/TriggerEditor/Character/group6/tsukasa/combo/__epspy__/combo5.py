...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDElseIf()(v.P_CountMain[playerID] == 1):
            ...
            _t15 = EUDIf()
            # (Line 138) &&Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill")
            # (Line 139) && v.P_Step[playerID] == 240)
            if _t15(EUDSCAnd()(Bring(playerID, AtLeast, 2, "Protoss Carrier", "[Skill]UseSkill"))(Bring(playerID, AtLeast, 1, "Protoss Arbiter", "[Skill]UseSkill"))(v.P_Step[playerID] == 240)()):
                # (Line 140) {
                # (Line 141) s.CharacterVoice(7);
                s.CharacterVoice(7)
                # (Line 142) v.P_SkillDelay[playerID] = 0;
                _ARRW(v.P_SkillDelay, playerID) << (0)
                # (Line 143) v.P_CountMain[playerID] = 0;
                _ARRW(v.P_CountMain, playerID) << (0)
                # (Line 144) v.P_LoopMain[playerID] = 0;
                _ARRW(v.P_LoopMain, playerID) << (0)
                # (Line 145) v.P_Step[playerID] = 250;
                _ARRW(v.P_Step, playerID) << (250)
                # (Line 146) KillUnitAt(2, "Protoss Carrier", "[Skill]UseSkill", playerID);
                # (Line 147) KillUnitAt(1, "Protoss Arbiter", "[Skill]UseSkill", playerID);
                ...
                # (Line 150) {
            if EUDElse()():
                # (Line 151) KillUnitAt(All, "60 + 1n Siege", "Anywhere", playerID);
