...
def f_main(playerID):
    ...
    if EUDIf()(v.P_WaitMain[playerID] == 0):
        ...
        if EUDIf()(v.P_CountMain[playerID] == 0):
            # (Line 11) {
            # (Line 12) if (v.P_LoopMain[playerID] < 2)
            if EUDIf()(v.P_LoopMain[playerID] >= 2, neg=True):
                # (Line 13) {
                # (Line 14) var x = 50 + 50 * v.P_LoopMain[playerID];
                x = EUDVariable()
                x << (50 + 50 * v.P_LoopMain[playerID])
                # (Line 16) trg.Shape_Square(playerID, 1, "40 + 1n Gantrithor", x, x);
                trg.Shape_Square(playerID, 1, "40 + 1n Gantrithor", x, x)
                # (Line 17) trg.Shape_Square(playerID, 1, "60 + 1n Archon", x, x);
                trg.Shape_Square(playerID, 1, "60 + 1n Archon", x, x)
                # (Line 19) KillUnitAt(All, "40 + 1n Gantrithor", "Anywhere", playerID);
                # (Line 20) KillUnitAt(All, "60 + 1n Archon", "Anywhere", playerID);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 2):
                # (Line 23) {
                # (Line 24) trg.Shape_Edge(playerID, 1, "50 + 1n Battlecruiser", 45, 3, 100);
                trg.Shape_Edge(playerID, 1, "50 + 1n Battlecruiser", 45, 3, 100)
                # (Line 25) trg.Shape_Edge(playerID, 1, "60 + 1n Dragoon", 45, 3, 100);
                trg.Shape_Edge(playerID, 1, "60 + 1n Dragoon", 45, 3, 100)
                # (Line 27) KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID);
                # (Line 28) }
                DoActions(KillUnitAt(All, "50 + 1n Battlecruiser", "Anywhere", playerID))
                # (Line 29) else if (v.P_LoopMain[playerID] == 3)
            if EUDElseIf()(v.P_LoopMain[playerID] == 3):
                # (Line 30) {
                # (Line 31) trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 50, 0);
                trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 50, 0)
                # (Line 32) trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 100, 0);
                trg.Shape_Square(playerID, 1, "40 + 1n Mojo", 100, 0)
                # (Line 33) epic.Shape_Square(playerID, 1, "60 + 1n Archon", 50, 0, 1);
                epic.Shape_Square(playerID, 1, "60 + 1n Archon", 50, 0, 1)
                # (Line 34) epic.Shape_Square(playerID, 1, "60 + 1n Archon", 100, 0, 1);
                ...
                # (Line 38) KillUnitAt(All, "60 + 1n Archon", "Anywhere", playerID);
            ...
            if EUDElseIf()(v.P_LoopMain[playerID] == 4):
                ...
                # (Line 44) trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 100, 100);
                DoActions(KillUnitAt(All, "40 + 1n Mojo", "Anywhere", playerID))
                trg.Shape_Square(playerID, 1, "60 + 1n Danimoth", 100, 100)
                # (Line 45) epic.Shape_Square(playerID, 1, "60 + 1n Archon", 100, 100, 1);
                ...
                DoActions(MoveLocation(v.P_LocationID[playerID], v.P_UnitID[playerID], playerID, "Anywhere"))
                # (Line 49) KillUnitAt(All, "60 + 1n Archon", "Anywhere", playerID);
                DoActions(Order("60 + 1n Danimoth", playerID, "Anywhere", Attack, v.P_LocationID[playerID]))
                # (Line 50) }
                DoActions(KillUnitAt(All, "60 + 1n Archon", "Anywhere", playerID))
                # (Line 51) else if (v.P_LoopMain[playerID] == 5)
            if EUDElseIf()(v.P_LoopMain[playerID] == 5):
                # (Line 52) {
                # (Line 53) KillUnitAt(All, "60 + 1n Danimoth", "Anywhere", playerID);
                # (Line 54) }
            ...
            # (Line 60) if (v.P_LoopMain[playerID] == 7)
