...
Trigger { -- Skill : Combo
   ...
   actions = {
      ...
      SetInvincibility(Enable, "Any unit", CurrentPlayer, "[Skill]Unit_Wait_ALL");
      MoveLocation("15.Rin", " * Devouring One", CurrentPlayer, "Anywhere");
      LMove(165, x - 4 * interval, y - 2 * interval);
      MoveUnit(1, "60 + 1n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "15.Rin");
      LMove(165, 4 * interval, 2 * interval);
      MoveUnit(1, "60 + 1n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "15.Rin");
      LMove(165, 4 * interval, -2 * interval);
      MoveUnit(1, "60 + 1n Siege", CurrentPlayer, "[Skill]Unit_Wait_ALL", "15.Rin");
      SetDeaths(CurrentPlayer, Add, 1, " `SkillLoop");
...
Trigger { -- Skill : Combo
   ...
   actions = {
      ...
      PreserveTrigger();
      Wait(2000);
      SetDeaths(AllPlayers, SetTo, 3005, " `SkillText3");
      Wait(3300);
